...
import { n as CustomVideoElement, t as MediaTracksMixin } from "./dist-vcd_De-S.js";
//#region node_modules/mux-embed/dist/mux.mjs
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var ea$1 = Object.create;
var _t$2 = Object.defineProperty;
var ta$1 = Object.getOwnPropertyDescriptor;
var ra$1 = Object.getOwnPropertyNames;
var aa$1 = Object.getPrototypeOf, ia$1 = Object.prototype.hasOwnProperty;
...
var na = function(r, e, t, i) {
	if (e && typeof e == "object" || typeof e == "function") for (var a = ra$1(e), n = 0, o = a.length, s; n < o; n++) s = a[n], !ia$1.call(r, s) && s !== t && _t$2(r, s, {
		get: function(u) {
			return e[u];
		}.bind(null, s),
		enumerable: !(i = ta$1(e, s)) || i.enumerable
	});
	return r;
};
var G$2 = function(r, e, t) {
	return t = r != null ? ea$1(aa$1(r)) : {}, na(e || !r || !r.__esModule ? _t$2(t, "default", {
		value: r,
		enumerable: !0
	}) : t, r);
};
...
function U$2(r, e) {
	return e != null && typeof Symbol != "undefined" && e[Symbol.hasInstance] ? !!e[Symbol.hasInstance](r) : U$2(r, e);
}
...
var fr$1 = B$3(function(Ps, _r) {
	...
	_r.exports = ve;
	function ve(r, e) {
		if (!U$2(this, ve)) return new ve(r, e);
...
var mr = B$3(function(Ls, pr) {
	...
	pr.exports = ae;
	function ae(r, e) {
		if (!U$2(this, ae)) return new ae(r);
...
var Ar = B$3(function(Gs, qr) {
	te$3();
	var Ya = Ye$1(), Xa = fr$1(), $a = mr(), De = rt$2(), Za = Sr(), ei = Dr(), ti = Xe$1(), ri = $e$1(), ai = Ze$1();
	qr.exports = Ue;
	function Ue() {
		if (!U$2(this, Ue)) return new Ue();
...
function H$2(r, e) {
	return pt$2(r) || mt$1(r, e) || Pe$2(r, e) || vt$2();
}
var be$1 = G$2(Q$2());
var Je$1 = G$2(Q$2());
var yt$2 = G$2(Q$2()), P$3 = { now: function() {
...
var J$2 = function(e) {
	if (e && typeof e.nodeName != "undefined") return e.muxId || (e.muxId = Oe$1()), e.muxId;
	var t;
	try {
...
function V$2(r) {
	return gt$2(r) || bt$2(r) || Pe$2(r) || wt$2();
}
var Y$2 = {
	TRACE: 0,
	DEBUG: 1,
	...
	return {
		trace: function() {
			...
			if (!(c > Y$2.TRACE)) return u.apply(void 0, V$2(x));
		},
		debug: function() {
			for (var w = arguments.length, x = new Array(w), v = 0; v < w; v++) x[v] = arguments[v];
			if (!(c > Y$2.DEBUG)) return h.apply(void 0, V$2(x));
		},
		info: function() {
			for (var w = arguments.length, x = new Array(w), v = 0; v < w; v++) x[v] = arguments[v];
			if (!(c > Y$2.INFO)) return f.apply(void 0, V$2(x));
		},
		warn: function() {
			for (var w = arguments.length, x = new Array(w), v = 0; v < w; v++) x[v] = arguments[v];
			if (!(c > Y$2.WARN)) return E.apply(void 0, V$2(x));
		},
		error: function() {
			for (var w = arguments.length, x = new Array(w), v = 0; v < w; v++) x[v] = arguments[v];
			if (!(c > Y$2.ERROR)) return y.apply(void 0, V$2(x));
		},
		get level() {
			return c;
		},
...
te$3();
function S$1(r, e) {
	if (!U$2(r, e)) throw new TypeError("Cannot call a class as a function");
}
function kt$2(r, e) {
...
function X$3(r) {
	return X$3 = Object.setPrototypeOf ? Object.getPrototypeOf : function(t) {
		return t.__proto__ || Object.getPrototypeOf(t);
	}, X$3(r);
}
function Et$1(r, e) {
	for (; !Object.prototype.hasOwnProperty.call(r, e) && (r = X$3(r), r !== null););
	return r;
}
function Se$2(r, e, t) {
...
var la = ["x-cdn", "content-type"], Pt$2 = [
	"x-request-id",
	"cf-ray",
	"x-amz-cf-id",
	"x-akamai-request-id"
...
var He$1 = function(r) {
	...
	if (!(!r || typeof r.getAllResponseHeaders != "function")) return pe$2(r.getAllResponseHeaders());
}, Ot$1 = function(r, e, t) {
	...
	var u = function(v, m) {
		...
		var A = He$1(T), R = A.bytesLoaded, Z = A.requestStart, we = A.responseStart, Te = A.responseEnd;
		u("requestcompleted", fe$3(ue$2({}, Me$1(D)), {
	...
	var h = function(v, m) {
		var _ = m.details, d = m.level, g = m.networkDetails, T = m.stats, k = He$1(T), D = k.bytesLoaded, L = k.requestStart, C = k.responseStart, A = k.responseEnd, R = _.fragments[_.fragments.length - 1], Z = s(R) + o(R.duration);
		u("requestcompleted", {
			request_event_type: v,
	...
	var E = function(v, m) {
		var _ = m.details, d = m.networkDetails, g = m.stats, T = He$1(g), k = T.bytesLoaded, D = T.requestStart, L = T.responseStart, C = T.responseEnd;
		u("requestcompleted", {
			request_event_type: v,
	...
	var y = function(v, m) {
		...
		_ = _ || g.stats;
		var T = He$1(_), k = T.bytesLoaded, D = T.requestStart, L = T.responseStart, C = T.responseEnd, A = d ? Re$2(d) : void 0, R = {
			request_event_type: v,
			request_bytes_loaded: k,
			request_start: D,
			request_response_start: L,
...
var It$1 = function(r, e) {
	...
	var t = F$2(r.url), i = r.url, a = r.bytesLoaded, n = new Date(r.requestStartDate).getTime(), o = new Date(r.firstByteDate).getTime(), s = new Date(r.requestEndDate).getTime(), u = isNaN(r.duration) ? 0 : r.duration, f = typeof e.getMetricsFor == "function" ? e.getMetricsFor(r.mediaType).HttpList : e.getDashMetrics().getHttpRequests(r.mediaType), h;
	f.length > 0 && (h = pe$2(f[f.length - 1]._responseHeaders || ""));
	var E = h ? le$1(h) : void 0;
	return {
		requestStart: n,
	...
	var p = {
		...
		if (T === "audio" || T === "video") {
			...
			p[T] = fe$3(ue$2({}, k), { codec: t.getCurrentTrackFor(T).codec });
			var C = w();
...
var Mt$2 = 0, Ht$2 = function() {
	"use strict";
	function r() {
		S$1(this, r), l$2(this, "_listeners", void 0);
	}
	return N$2(r, [
		{
			key: "on",
...
var Be$1 = G$2(Q$2()), Bt$2 = function() {
	...
	function r(e) {
		var t = this;
		S$1(this, r), l$2(this, "_playbackHeartbeatInterval", void 0), l$2(this, "_playheadShouldBeProgressing", void 0), l$2(this, "pm", void 0), this.pm = e, this._playbackHeartbeatInterval = null, this._playheadShouldBeProgressing = !1, e.on("playing", function() {
			...
			t._playbackHeartbeatInterval !== null && (Be$1.default.clearInterval(t._playbackHeartbeatInterval), e.emit("playbackheartbeatend", { viewer_time: a.viewer_time }), t._playbackHeartbeatInterval = null);
		});
	}
	return N$2(r, [{
...
var Ut$2 = function r(e) {
	"use strict";
	var t = this;
	S$1(this, r), l$2(this, "viewErrored", void 0), e.on("viewinit", function() {
		t.viewErrored = !1;
...
var Ft$2 = function() {
	"use strict";
	function r(e) {
		S$1(this, r), l$2(this, "_watchTimeTrackerLastCheckedTime", void 0), l$2(this, "pm", void 0), this.pm = e, this._watchTimeTrackerLastCheckedTime = null, e.on("playbackheartbeat", this._updateWatchTime.bind(this)), e.on("playbackheartbeatend", this._clearWatchTimeState.bind(this));
	}
	return N$2(r, [{
...
var Vt$2 = function() {
	...
	function r(e) {
		var t = this;
		S$1(this, r), l$2(this, "_playbackTimeTrackerLastPlayheadPosition", void 0), l$2(this, "_lastTime", void 0), l$2(this, "_isAdPlaying", void 0), l$2(this, "_callbackUpdatePlaybackTime", void 0), l$2(this, "pm", void 0), this.pm = e, this._playbackTimeTrackerLastPlayheadPosition = -1, this._lastTime = P$3.now(), this._isAdPlaying = !1, this._callbackUpdatePlaybackTime = null, e.on("viewinit", function() {
	...
	return N$2(r, [
		...
		},
		{
			...
			value: function() {
				...
				this._playbackTimeTrackerLastPlayheadPosition >= 0 && t > this._playbackTimeTrackerLastPlayheadPosition ? n = t - this._playbackTimeTrackerLastPlayheadPosition : this._isAdPlaying && (n = a), n > 0 && n <= 1e3 && O$2(this.pm.data, "view_content_playback_time", n), this._callbackUpdatePlaybackTime !== null && a > 0 && a <= 1e3 && (this._isAdPlaying && O$2(this.pm.data, "ad_playing_time_ms_cumulative", a), O$2(this.pm.data, "view_playing_time_ms_cumulative", a)), this._playbackTimeTrackerLastPlayheadPosition = t, this._lastTime = i;
			}
		}
	]), r;
}();
var jt$2 = function() {
	"use strict";
	function r(e) {
		S$1(this, r), l$2(this, "pm", void 0), this.pm = e;
...
var Wt$1 = 300 * 1e3, Gt$2 = function r(e) {
	"use strict";
	if (S$1(this, r), !e.disableRebufferTracking) {
		var t, i = function(n, o) {
			a(o), t = void 0;
		}, a = function(n) {
			if (t) {
				var o = n.viewer_time - t;
				O$2(e.data, "view_rebuffer_duration", o), t = n.viewer_time, e.data.view_rebuffer_duration > Wt$1 && (e.emit("viewend"), e.send("viewend"), e.mux.log.warn("Ending view after rebuffering for longer than ".concat(Wt$1, "ms, future events will be ignored unless a programchange or videochange occurs.")));
			}
		...
		e.on("playbackheartbeat", function(n, o) {
			...
			t || (O$2(e.data, "view_rebuffer_count", 1), t = o.viewer_time, e.one("rebufferend", i));
		}), e.on("viewinit", function() {
...
var Jt$2 = function() {
	...
	function r(e) {
		var t = this;
		S$1(this, r), l$2(this, "_lastCheckedTime", void 0), l$2(this, "_lastPlayheadTime", void 0), l$2(this, "_lastPlayheadTimeUpdatedTime", void 0), l$2(this, "_rebuffering", void 0), l$2(this, "pm", void 0), this.pm = e, !(e.disableRebufferTracking || e.disablePlayheadRebufferTracking) && (this._lastCheckedTime = null, this._lastPlayheadTime = null, this._lastPlayheadTimeUpdatedTime = null, e.on("playbackheartbeat", this._checkIfRebuffering.bind(this)), e.on("playbackheartbeatend", this._cleanupRebufferTracker.bind(this)), e.on("seeking", function() {
...
var Qt$2 = function() {
	...
	function r(e) {
		var t = this;
		S$1(this, r), l$2(this, "pm", void 0), this.pm = e, e.on("viewinit", function() {
...
var zt$1 = function r(e) {
	"use strict";
	var t = this;
	S$1(this, r), l$2(this, "_lastPlayerHeight", void 0), l$2(this, "_lastPlayerWidth", void 0), l$2(this, "_lastPlayheadPosition", void 0), l$2(this, "_lastSourceHeight", void 0), l$2(this, "_lastSourceWidth", void 0), e.on("viewinit", function() {
	...
	[
		...
		e.on(n, function() {
			if (t._lastPlayheadPosition >= 0 && e.data.player_playhead_time >= 0 && t._lastPlayerWidth >= 0 && t._lastSourceWidth > 0 && t._lastPlayerHeight >= 0 && t._lastSourceHeight > 0) {
				...
				e.data.view_max_upscale_percentage = Math.max(e.data.view_max_upscale_percentage || 0, u), e.data.view_max_downscale_percentage = Math.max(e.data.view_max_downscale_percentage || 0, f), O$2(e.data, "view_total_content_playback_time", o), O$2(e.data, "view_total_upscaling", u * o), O$2(e.data, "view_total_downscaling", f * o);
			}
			t._lastPlayheadPosition = -1;
		});
	}), [
...
var xa$1 = 2e3, Kt$2 = function r(e) {
	"use strict";
	var t = this;
	S$1(this, r), l$2(this, "isSeeking", void 0), this.isSeeking = !1;
	var i = -1, a = function() {
		var n = P$3.now(), o = (e.data.viewer_time || n) - (i || n);
		O$2(e.data, "view_seek_duration", o), e.data.view_max_seek_time = Math.max(e.data.view_max_seek_time || 0, o), t.isSeeking = !1, i = -1;
	};
	e.on("seeking", function(n, o) {
		...
		t.isSeeking && a(), t.isSeeking = !0, i = o.viewer_time, O$2(e.data, "view_seek_count", 1), e.send("seeking");
...
var Yt$2 = function(e, t) {
	...
	function r(e) {
		...
		e.on("adbreakstart", function() {
			...
			n = Object.assign({ ad_request_id: "generatedAdRequestId" + t._currentAdRequestNumber++ }, n), Yt$2(t._adRequests, n), O$2(e.data, "view_ad_request_count"), t.inPrerollPosition() && (e.data.view_preroll_requested = !0, t._adHasPlayed || O$2(e.data, "view_preroll_request_count"));
			...
			o && O$2(e.data, "view_ad_request_time", Math.max(0, n.viewer_time - o.viewer_time));
		}), e.on("adplay", function(a, n) {
			t._adHasPlayed = !0, t._wouldBeNewAdPlay && (t._wouldBeNewAdPlay = !1, O$2(e.data, "view_ad_played_count")), t.inPrerollPosition() && !e.data.view_preroll_played && (e.data.view_preroll_played = !0, t._adRequests.length > 0 && (e.data.view_preroll_request_time = Math.max(0, n.viewer_time - t._adRequests[0].viewer_time)), e.data.view_start && (e.data.view_startup_preroll_request_time = Math.max(0, n.viewer_time - e.data.view_start)), t._prerollPlayTime = n.viewer_time);
			...
			t._wouldBeNewAdPlay || O$2(e.data, "view_ad_clicked_count");
		}), e.on("adskipped", function(a, n) {
			t._wouldBeNewAdPlay || O$2(e.data, "view_ad_skipped_count");
		}), e.on("adended", function() {
...
var $t$2 = function r(e) {
	"use strict";
	var t = this;
	S$1(this, r), l$2(this, "lastWallClockTime", void 0);
	var i = function() {
...
var Zt$2 = "muxData", Aa$1 = function(r) {
	...
	try {
		ze$2.set(Zt$2, Aa$1(e), { expires: 365 });
	} catch (t) {}
}, rr$1 = function() {
	var e = er$1();
...
var ir$1 = G$2(Q$2()), nr$1 = function() {
	var e;
	switch (or()) {
		case "cellular":
			e = "cellular";
...
function me$3(r) {
	...
	return Object.keys(r).forEach(function(i) {
		...
		if (r.hasOwnProperty(i) && r[i] !== void 0) {
			...
			s || (q$2.info("Data key word `" + n[0] + "` not expected in " + i), s = o + "_"), n.splice(1).forEach(function(u) {
				u === "url" && (a = !0), ur$1[u] ? s += ur$1[u] : Number.isInteger(Number(u)) ? s += u : (q$2.info("Data key word `" + u + "` not expected in " + i), s += "_" + u + "_");
			}), a ? t[s] = r[i] : e[s] = r[i];
		}
	}), Object.assign(e, t);
}
...
var oi = {
	...
	"requestfailed",
	"requestcanceled"
], li = "https://img.litix.io", $$1 = function(e) {
...
$$1.prototype.queueEvent = function(r, e) {
...
$$1.prototype.destroy = function() {
	...
	this.destroyed = !0, r ? this._clearBeaconQueue() : this.flushEvents(), ie$2.default.clearTimeout(this._sendTimeout);
};
...
$$1.prototype._sendBeaconQueue = function() {
	...
	Cr(this._beaconUrl, t, !1, function(a, n) {
		n ? (r._eventQueue = e.concat(r._eventQueue), r._failureCount += 1, q$2.info("Error sending beacon: " + n)) : r._failureCount = 0, r._roundTripTime = P$3.now() - i, r._postInFlight = !1, r._resendAfterPost && (r._resendAfterPost = !1, r._eventQueue.length > 0 && r._sendBeaconQueue());
	});
};
...
$$1.prototype._createPayload = function(r) {
	...
	return o(), s() || (q$2.info("Payload size is too big (" + n + " kb). Removing unnecessary events."), a = r.filter(function(u) {
		return ui.indexOf(u.e) === -1;
	}), o()), s() || (q$2.info("Payload size still too big (" + n + " kb). Cropping fields.."), a.forEach(function(u) {
		for (var f in u) {
			var h = u[f], E = 50 * 1024;
...
var ci = [
	...
	function r(e, t) {
		...
		l$2(this, "mux", void 0), l$2(this, "envKey", void 0), l$2(this, "options", void 0), l$2(this, "eventQueue", void 0), l$2(this, "sampleRate", void 0), l$2(this, "disableCookies", void 0), l$2(this, "respectDoNotTrack", void 0), l$2(this, "previousBeaconData", void 0), l$2(this, "lastEventTime", void 0), l$2(this, "rateLimited", void 0), l$2(this, "pageLevelData", void 0), l$2(this, "viewerData", void 0), this.mux = e, this.envKey = t, this.options = i, this.previousBeaconData = null, this.lastEventTime = 0, this.rateLimited = !1, this.eventQueue = new Mr(Ke$1(this.envKey, this.options));
		var x;
	...
	return N$2(r, [
		{
			...
			value: function(t, i) {
				if (!(!t || !(i != null && i.view_id))) {
					if (this.respectDoNotTrack && ce$2()) return q$2.info("Not sending `" + t + "` because Do Not Track is enabled");
					if (!i || typeof i != "object") return q$2.error("A data object was expected in send() but was not provided");
					var a = this.disableCookies ? {} : ar(), n = fe$3(ue$2({}, this.pageLevelData, i, a, this.viewerData), {
						event: t,
						env_key: this.envKey
					});
					...
					if (this.lastEventTime = this.mux.utils.now(), s) return q$2.info("Not sending event due to sample rate restriction", t, n, f);
					if (this.envKey || q$2.info("Missing environment key (envKey) - beacons will be dropped if the video source is not a valid mux video URL", t, n, f), !this.rateLimited) if (q$2.info("Sending event", t, n, f), this.rateLimited = !this.eventQueue.queueEvent(t, f), this.mux.WINDOW_UNLOADING && t === "viewend") this.eventQueue.destroy(!0);
					else {
						...
						if (this.rateLimited) return n.event = "eventrateexceeded", f = me$3(n), this.eventQueue.queueEvent(n.event, f), q$2.error("Beaconing disabled due to rate limit.");
					}
				}
			}
		},
		...
		},
		{
			...
			value: function(t, i) {
				...
				if (o === "-1" || t === "viewstart" || t === "viewend" || !this.previousBeaconData || this.mux.utils.now() - this.lastEventTime >= mi) n = ue$2({}, i), o && (this.previousBeaconData = n), o && t === "viewend" && (this.previousBeaconData = null);
				else {
		...
		},
		{
			...
			value: function(t, i) {
				return !!(t === "renditionchange" && i.indexOf("video_source_") === 0 || fi.includes(i) && _i$1.includes(t) || t === "playbackmodechange" && i.indexOf("player_playback_mode") === 0);
			}
		}
	]), r;
}();
...
var hi = 3600 * 1e3, Ur = function r(e) {
	"use strict";
	var t = this;
	S$1(this, r), l$2(this, "_lastEventTime", void 0), e.on("before*", function(i, a) {
		...
		if (t._lastEventTime = o, s && o - s > hi) {
			var u = Object.keys(e.data).reduce(function(h, E) {
				return E.indexOf("video_") === 0 ? Object.assign(h, l$2({}, E, e.data[E])) : h;
			}, {});
...
var Ti = function(r) {
	...
	"use strict";
	var t = this;
	S$1(this, r), l$2(this, "_emittingAutomaticEvent", !1), l$2(this, "_hasInitialized", !1), l$2(this, "_currentMode", "standard"), e.on("viewstart", function() {
...
var Wr = function() {
	"use strict";
	function r(e) {
		S$1(this, r), l$2(this, "pm", void 0), l$2(this, "_currentRangeStart", void 0), l$2(this, "_lastPlayheadTime", void 0), this.pm = e, this._currentRangeStart = null, this._lastPlayheadTime = null, e.on("playbackheartbeat", this._updatePlaybackRange.bind(this)), e.on("playbackheartbeatend", this._endPlaybackRange.bind(this));
	}
	return N$2(r, [
		{
...
var xi = [
	...
	function t(i, a, n) {
		...
		}, n), n.data = n.data || {}, n.data.property_key && (n.data.env_key = n.data.property_key, delete n.data.property_key), q$2.level = n.debug ? Y$2.DEBUG : Y$2.WARN, o.getPlayheadTime = n.getPlayheadTime, o.getStateData = n.getStateData || function() {
			return {};
		...
		return o.one("playerready", E), o.longResumeTracker = new Ur(b$3(o)), o.errorTracker = new Ut$2(b$3(o)), new $t$2(b$3(o)), o.seekingTracker = new Kt$2(b$3(o)), o.playheadTime = new jt$2(b$3(o)), o.playbackHeartbeat = new Bt$2(b$3(o)), new zt$1(b$3(o)), o.watchTimeTracker = new Ft$2(b$3(o)), new Vt$2(b$3(o)), new Wr(b$3(o)), o.adTracker = new Xt$1(b$3(o)), new Jt$2(b$3(o)), new Gt$2(b$3(o)), new Qt$2(b$3(o)), new Br(b$3(o)), new Vr(b$3(o)), new jr(b$3(o)), n.hlsjs && o.addHLSJS(n), n.dashjs && o.addDashJS(n), o.emit("viewinit", n.data), o;
	}
	return N$2(t, [
		{
			key: "emit",
			value: function(a, n) {
				...
				u != null && u.length && (o = Se$2(X$3(t.prototype), "emit", this)).call.apply(o, [this].concat(V$2(u)));
			}
		},
		{
			key: "destroy",
		...
		},
		{
			...
			value: function() {
				var a = this, n = this.data.view_id = ee$3(), o = function() {
					n === a.data.view_id && O$2(a.data, "player_view_count", 1);
				};
		...
		},
		{
			...
			value: function(a) {
				...
				this.hlsjs = a.hlsjs, Ot$1(this.mux, this.id, a.hlsjs, {}, a.Hls || window.Hls);
			}
		},
		{
			key: "removeHLSJS",
...
function ut$2(r, e) {
	if (!r || !e || !ge$2.default || typeof ge$2.default.getComputedStyle != "function") return "";
	var t;
	return ye$2 && ye$2.has(r) && (t = ye$2.get(r)), t || (t = ge$2.default.getComputedStyle(r, null), ye$2 && ye$2.set(r, t)), t.getPropertyValue(e);
}
function lt$2(r) {
...
var Mi = "mux-embed", Hi = "5.17.10", Bi = "2.1", M$3 = {}, ne$3 = function(e) {
	var t = arguments;
	typeof e == "string" ? ne$3.hasOwnProperty(e) ? be$1.default.setTimeout(function() {
		t = Array.prototype.splice.call(t, 1), ne$3[e].apply(null, t);
	}, 0) : q$2.warn("`" + e + "` is an unknown task") : typeof e == "function" ? be$1.default.setTimeout(function() {
		e(ne$3);
	}, 0) : q$2.warn("`" + e + "` is invalid.");
}, Ui = {
	loaded: P$3.now(),
	NAME: Mi,
	VERSION: Hi,
	...
	destroyMonitor: function(e) {
		...
		i && i.mux && typeof i.mux.destroy == "function" ? i.mux.destroy() : q$2.error("A video element monitor for `" + e + "` has not been initialized via `mux.monitor`.");
	},
	addHLSJS: function(e, t) {
		var i = J$2(e);
		M$3[i] ? M$3[i].addHLSJS(t) : q$2.error("A monitor for `" + i + "` has not been initialized.");
	},
	addDashJS: function(e, t) {
		var i = J$2(e);
		M$3[i] ? M$3[i].addDashJS(t) : q$2.error("A monitor for `" + i + "` has not been initialized.");
	},
	removeHLSJS: function(e) {
		var t = J$2(e);
		M$3[t] ? M$3[t].removeHLSJS() : q$2.error("A monitor for `" + t + "` has not been initialized.");
	},
	removeDashJS: function(e) {
		var t = J$2(e);
		M$3[t] ? M$3[t].removeDashJS() : q$2.error("A monitor for `" + t + "` has not been initialized.");
	},
	init: function(e, t) {
		ce$2() && t && t.respectDoNotTrack && q$2.info("The browser's Do Not Track flag is enabled - Mux beaconing is disabled.");
		var i = J$2(e);
		M$3[i] = new Gr(ne$3, i, t);
	},
	emit: function(e, t, i) {
		var a = J$2(e);
		M$3[a] ? (M$3[a].emit(t, i), t === "destroy" && delete M$3[a]) : q$2.error("A monitor for `" + a + "` has not been initialized.");
	},
	updateData: function(e, t) {
		var i = J$2(e);
		M$3[i] ? M$3[i].emit("hb", t) : q$2.error("A monitor for `" + i + "` has not been initialized.");
	},
	setEmitTranslator: function(e, t) {
		var i = J$2(e);
		M$3[i] ? M$3[i].emitTranslator = t : q$2.error("A monitor for `" + i + "` has not been initialized.");
	},
	setStateDataTranslator: function(e, t) {
		var i = J$2(e);
		M$3[i] ? M$3[i].stateDataTranslator = t : q$2.error("A monitor for `" + i + "` has not been initialized.");
	},
	setGetPlayheadTime: function(e, t) {
		var i = J$2(e);
		M$3[i] ? M$3[i].getPlayheadTime = t : q$2.error("A monitor for `" + i + "` has not been initialized.");
	},
...
typeof be$1.default != "undefined" && typeof be$1.default.addEventListener == "function" && be$1.default.addEventListener("pagehide", function(r) {
...
}, V$1 = (e) => e === v$1.VIDEO ? "playback" : e, _$1 = class _ extends Error {
...
_$1.MEDIA_ERR_ABORTED = 1, _$1.MEDIA_ERR_NETWORK = 2, _$1.MEDIA_ERR_DECODE = 3, _$1.MEDIA_ERR_SRC_NOT_SUPPORTED = 4, _$1.MEDIA_ERR_ENCRYPTED = 5, _$1.MEDIA_ERR_CUSTOM = 100, _$1.defaultMessages = {
...
var m = _$1, at$1 = (e) => e == null, H$1 = (e, t) => at$1(t) ? !1 : e in t, F$1 = {
	ANY: "any",
	MUTED: "muted"
}, L$1 = {
	ON_DEMAND: "on-demand",
...
var B$2 = (e) => {
	...
	if (t) {
		let r = t.toUpperCase();
		return H$1(r, Y$1) ? Y$1[r] : t;
	}
	return it$1(e);
}, ee$2 = (e) => e === "VOD" ? L$1.ON_DEMAND : L$1.LIVE, te$2 = (e) => e === "EVENT" ? Number.POSITIVE_INFINITY : e === "VOD" ? NaN : 0, it$1 = (e) => {
	let { src: t } = e;
	if (!t) return "";
	let r = "";
	try {
...
}, Ee$1 = ({ exp: e }, t = Date.now()) => !e || e * 1e3 < t, ge$1 = ({ sub: e }, t) => e !== t, Me = ({ aud: e }, t) => !e, be = ({ aud: e }, t) => e !== t, Re$1 = "en";
function x$4(e, t = !0) {
	var o, s;
	return new Z(t && (s = (o = $) == null ? void 0 : o[e]) != null ? s : e, t ? $.code : Re$1);
}
var Z = class {
	constructor(t, r = ((n) => (n = $) != null ? n : Re$1)()) {
...
var dt$1 = Object.values(F$1), xe$2 = (e) => typeof e == "boolean" || typeof e == "string" && dt$1.includes(e), Ce$1 = (e, t, r) => {
	let { autoplay: n } = e, o = !1, s = !1, a = xe$2(n) ? n : !!n, i = () => {
		o || P$2(t, "playing", () => {
			o = !0;
		}, { once: !0 });
	};
	if (i(), P$2(t, "loadstart", () => {
		...
		r || (e.streamType && e.streamType !== L$1.UNKNOWN ? s = e.streamType === L$1.LIVE : s = !Number.isFinite(t.duration)), ne$2(t, a);
	}, { once: !0 }), r && r.once(R$1.Events.LEVEL_LOADED, (d, f) => {
		var u;
		e.streamType && e.streamType !== L$1.UNKNOWN ? s = e.streamType === L$1.LIVE : s = (u = f.details.live) != null ? u : !1;
	}), !a) {
		let d = () => {
		...
		r && P$2(t, "play", () => {
			t.preload === "metadata" ? r.once(R$1.Events.LEVEL_UPDATED, d) : d();
		}, { once: !0 });
	}
	return (d) => {
		o || (a = xe$2(d) ? d : !!d, ne$2(t, a));
	};
}, ne$2 = (e, t) => {
	if (!t) return;
...
function De(e, t) {
	...
	t.on(R$1.Events.MANIFEST_PARSED, function(c, d) {
		a();
	...
	}), t.on(R$1.Events.AUDIO_TRACKS_UPDATED, function(c, d) {
		s();
		...
		var f;
		let c = +((f = [...e.audioTracks].find((u) => u.enabled)) == null ? void 0 : f.id), d = t.audioTracks.map((u) => u.id);
		c != t.audioTrack && d.includes(c) && (t.audioTrack = c);
	}), t.on(R$1.Events.LEVELS_UPDATED, function(c, d) {
		var p;
	...
	t.once(R$1.Events.DESTROYING, a);
}
...
function ke$1(e, t) {
	t.on(R$1.Events.NON_NATIVE_TEXT_TRACKS_FOUND, (o, { tracks: s }) => {
		s.forEach((a) => {
			...
			ae$2(e, a.kind, a.label, i == null ? void 0 : i.lang, d, a.default);
		});
	});
	let r = () => {
		...
		if (t.subtitleTrack < 0 || (o == null ? void 0 : o.id) !== a) t.subtitleTrack = t.subtitleTracks.findIndex(({ lang: c, name: d, type: f, default: u }) => o.id === "default" && u || c == o.language && d === o.label && f.toLowerCase() === o.kind);
		...
		Array.from(e.textTracks).forEach((o) => {
			...
			if (!["subtitles", "caption"].includes(o.kind) && (o.label === "thumbnails" || o.kind === "chapters")) {
				if (!((s = o.cues) != null && s.length)) {
					...
					c?.removeAttribute("src"), setTimeout(() => {
...
async function Pe$1(e, t, r, n) {
	...
	return o || (o = ae$2(e, n, r), o.mode = "hidden", await new Promise((s) => setTimeout(() => s(void 0), 0))), o.mode !== "hidden" && (o.mode = "hidden"), [...t].sort((s, a) => oe$2(a) - oe$2(s)).forEach((s) => {
		...
		if ("endTime" in s && s.endTime != null) o?.addCue(new VTTCue(i, s.endTime, n === "chapters" ? a : JSON.stringify(a != null ? a : null)));
			...
			l && (l.endTime = i), o?.addCue(new VTTCue(i, p, n === "chapters" ? a : JSON.stringify(a != null ? a : null)));
		}
...
async function Le(e, t, r = he$1) {
	return Pe$1(e, t, r.label, "metadata");
}
var j$1 = (e) => ({
	time: e.startTime,
...
function pt$1(e, t = { label: se$2 }) {
	let r = O$1(e, t.label, "metadata");
	return r != null && r.cues ? Array.from(r.cues, (n) => j$1(n)) : [];
}
function _e$1(e, t = { label: se$2 }) {
	...
	let { currentTime: n } = e;
	return j$1(Array.prototype.find.call((a = r.activeCues) != null ? a : [], ({ startTime: i, endTime: c }) => i <= n && c > n) || r.activeCues[0]);
}
...
var ie$1 = "chapters", Ae$1 = Object.freeze({ label: ie$1 }), J$1 = (e) => ({
	startTime: e.startTime,
	endTime: e.endTime,
	value: e.text
});
async function Se$1(e, t, r = Ae$1) {
	return Pe$1(e, t, r.label, "chapters");
}
function ft(e, t = { label: ie$1 }) {
	var n;
	let r = O$1(e, t.label, "chapters");
	return (n = r == null ? void 0 : r.cues) != null && n.length ? Array.from(r.cues, (o) => J$1(o)) : [];
}
function Ie$1(e, t = { label: ie$1 }) {
	var s, a;
	let r = O$1(e, t.label, "chapters");
	if (!((s = r == null ? void 0 : r.activeCues) != null && s.length)) return;
	if (r.activeCues.length === 1) return J$1(r.activeCues[0]);
...
var ce$1 = {
	...
	if (e === v$1.VIDEO) return ce$1.VIDEO;
	if (e === v$1.DRM) return ce$1.DRM;
}, Et = (e, t) => {
	var o, s;
	...
	var E, D;
	if (s) {
		let g = x$4("Your device appears to be offline", o), b = void 0, y = m.MEDIA_ERR_NETWORK, h = new m(g, y, !1, b);
	...
	if (i === 200) return;
	let f = V$1(t), u = Et(t, r), p = mt(t), [l] = B$2((E = r.playbackId) != null ? E : "");
	if (!i || !l) return;
	let T = re$2(u);
	if (u && !T) {
		let y = new m(x$4("The {tokenNamePrefix}-token provided is invalid or malformed.", o).format({ tokenNamePrefix: f }), d, !0, x$4("Compact JWT string: {token}", o).format({ token: u }));
		return y.errorCategory = t, y.muxCode = C$3.NETWORK_TOKEN_MALFORMED, y.data = e, y;
	}
	if (i >= 500) {
	...
	if (i === 403) if (T) {
		if (Ee$1(T, c)) {
			let g = {
				timeStyle: "medium",
				dateStyle: "medium"
			}, h = new m(x$4("The video’s secured {tokenNamePrefix}-token has expired.", o).format({ tokenNamePrefix: f }), d, !0, x$4("Expired at: {expiredDate}. Current time: {currentDate}.", o).format({
				expiredDate: new Intl.DateTimeFormat("en", g).format((D = T.exp) != null ? D : 0),
				currentDate: new Intl.DateTimeFormat("en", g).format(c)
			}));
			return h.errorCategory = t, h.muxCode = C$3.NETWORK_TOKEN_EXPIRED, h.data = e, h;
		}
		if (ge$1(T, l)) {
			let y = new m(x$4("The video’s playback ID does not match the one encoded in the {tokenNamePrefix}-token.", o).format({ tokenNamePrefix: f }), d, !0, x$4("Specified playback ID: {playbackId} and the playback ID encoded in the {tokenNamePrefix}-token: {tokenPlaybackId}", o).format({
				tokenNamePrefix: f,
				playbackId: l,
				tokenPlaybackId: T.sub
			}));
			return y.errorCategory = t, y.muxCode = C$3.NETWORK_TOKEN_SUB_MISMATCH, y.data = e, y;
		}
		if (Me(T, p)) {
			let y = new m(x$4("The {tokenNamePrefix}-token is formatted with incorrect information.", o).format({ tokenNamePrefix: f }), d, !0, x$4("The {tokenNamePrefix}-token has no aud value. aud value should be {expectedAud}.", o).format({
				tokenNamePrefix: f,
				expectedAud: p
			}));
			return y.errorCategory = t, y.muxCode = C$3.NETWORK_TOKEN_AUD_MISSING, y.data = e, y;
		}
		if (be(T, p)) {
			let y = new m(x$4("The {tokenNamePrefix}-token is formatted with incorrect information.", o).format({ tokenNamePrefix: f }), d, !0, x$4("The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.", o).format({
				tokenNamePrefix: f,
				expectedAud: p,
				aud: T.aud
			}));
			return y.errorCategory = t, y.muxCode = C$3.NETWORK_TOKEN_AUD_MISMATCH, y.data = e, y;
		}
	} else {
		let g = x$4("Authorization error trying to access this {category} URL. If this is a signed URL, you might need to provide a {tokenNamePrefix}-token.", o).format({
			tokenNamePrefix: f,
			category: t
		}), b = x$4("Specified playback ID: {playbackId}", o).format({ playbackId: l }), y = new m(g, d, n != null ? n : !0, b);
		return y.errorCategory = t, y.muxCode = C$3.NETWORK_TOKEN_MISSING, y.data = e, y;
	}
	if (i === 412) {
		let g = x$4("This playback-id may belong to a live stream that is not currently active or an asset that is not ready.", o), b = x$4("Specified playback ID: {playbackId}", o).format({ playbackId: l }), y = new m(g, d, n != null ? n : !0, b);
		return y.errorCategory = t, y.muxCode = C$3.NETWORK_NOT_READY, y.streamType = r.streamType === L$1.LIVE ? "live" : r.streamType === L$1.ON_DEMAND ? "on-demand" : "unknown", y.data = e, y;
	}
	if (i === 404) {
		let g = x$4("This URL or playback-id does not exist. You may have used an Asset ID or an ID from a different resource.", o), b = x$4("Specified playback ID: {playbackId}", o).format({ playbackId: l }), y = new m(g, d, n != null ? n : !0, b);
		return y.errorCategory = t, y.muxCode = C$3.NETWORK_NOT_FOUND, y.data = e, y;
	}
	if (i === 400) {
		let g = x$4("The URL or playback-id was invalid. You may have used an invalid value as a playback-id."), b = x$4("Specified playback ID: {playbackId}", o).format({ playbackId: l }), y = new m(g, d, n != null ? n : !0, b);
		return y.errorCategory = t, y.muxCode = C$3.NETWORK_INVALID_URL, y.data = e, y;
	}
	let M = new m("", d, n != null ? n : !0);
	return M.errorCategory = t, M.muxCode = C$3.NETWORK_UNKNOWN_ERROR, M.data = e, M;
};
var Oe = R$1.DefaultConfig.capLevelController, gt$1 = {
	"720p": 921600,
	"1080p": 2073600,
	"1440p": 4194304,
	"2160p": 8294400
...
var bt$1 = "com.apple.fps.1_0", Rt = "application/vnd.apple.mpegurl", Ue = ({ mediaEl: e, getAppCertificate: t, getLicenseKey: r, saveAndDispatchError: n, drmTypeCb: o }) => {
	if (!window.WebKitMediaKeys || !("onwebkitneedkey" in e)) {
		...
		let l = new m(x$4("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser."), m.MEDIA_ERR_ENCRYPTED, !0);
	...
	let s = e, a = t(), i = null, c = (p) => {
		...
		try {
			let p = new WebKitMediaKeys(bt$1);
		...
		let l = s.webkitKeys.createSession(Rt, p), T = async (D) => {
			...
			let y = new m(x$4("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser."), m.MEDIA_ERR_ENCRYPTED, !0);
			y.errorCategory = v$1.DRM, y.muxCode = C$3.ENCRYPTED_CDM_ERROR, n(e, y);
		}, E = () => {
		...
		"webkitCurrentPlaybackTargetIsWireless" in e && e.addEventListener("webkitcurrentplaybacktargetiswirelesschanged", E, { once: !0 }), l.addEventListener("webkitkeymessage", T), l.addEventListener("webkitkeyerror", M), e.addEventListener("teardown", E), i = E;
	}, u = () => {
		e.removeEventListener("webkitneedkey", c), e.removeEventListener("teardown", u), i?.();
		try {
			s.webkitSetMediaKeys(null);
		} catch {}
	};
	return e.addEventListener("webkitneedkey", c), e.addEventListener("teardown", u, { once: !0 }), u;
}, xt = (e, t) => {
	let r = vt$1(Ct$1(e)), n = new Uint8Array(e), o = new Uint8Array(r), s = new Uint8Array(t), a = n.byteLength + 4 + s.byteLength + 4 + o.byteLength, i = new Uint8Array(a), c = 0, d = (u) => {
...
}, Ct$1 = (e) => new TextDecoder("utf-16le").decode(e).replace("skd://", "").slice(1);
function vt$1(e) {
...
var He = ({ mediaEl: e, getAppCertificate: t, getLicenseKey: r, saveAndDispatchError: n, drmTypeCb: o, fallbackToWebkitFairplay: s }) => {
	let a = null, i = async (u) => {
		...
		let p = await navigator.requestMediaKeySystemAccess("com.apple.fps", [{
			...
			let M = new m(x$4("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser."), m.MEDIA_ERR_ENCRYPTED, !0);
		...
		try {
			...
			await l.setServerCertificate(T).catch(() => {
				let E = new m(x$4("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate."), m.MEDIA_ERR_ENCRYPTED, !0);
		...
		let l = e.mediaKeys.createSession(), T = async (D) => {
			...
			try {
				...
				let h = new m(x$4("Failed to update DRM license. This may be an issue with the player or your protected content."), m.MEDIA_ERR_ENCRYPTED, !0);
				h.errorCategory = v$1.DRM, h.muxCode = C$3.ENCRYPTED_UPDATE_LICENSE_FAILED, n(e, h);
			}
		}, M = () => {
			let D = (g) => {
				let b;
				if (g === "internal-error") b = new m(x$4("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser."), m.MEDIA_ERR_ENCRYPTED, !0), b.errorCategory = v$1.DRM, b.muxCode = C$3.ENCRYPTED_CDM_ERROR;
				else if (g === "output-restricted" || g === "output-downscaled") b = new m(x$4("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen."), m.MEDIA_ERR_ENCRYPTED, !1), b.errorCategory = v$1.DRM, b.muxCode = C$3.ENCRYPTED_OUTPUT_RESTRICTED;
				b && n(e, b);
			};
		...
		"webkitCurrentPlaybackTargetIsWireless" in e && e.addEventListener("webkitcurrentplaybacktargetiswirelesschanged", E, { once: !0 }), e.addEventListener("teardown", E, { once: !0 }), a = E, await l.generateRequest(u, p).catch(async (D) => {
			if (D.name === "NotSupportedError" && "webkitCurrentPlaybackTargetIsWireless" in e && e.webkitCurrentPlaybackTargetIsWireless) console.warn("Failed to generate a DRM license request. Attempting to fallback to Webkit DRM"), s?.();
				...
				let b = new m(x$4("Failed to generate a DRM license request. This may be an issue with the player or your protected content."), m.MEDIA_ERR_ENCRYPTED, !0);
...
var wt$1 = (e) => {
	var i, c, d;
	let t = e.split(`
`), n = (c = ((i = t.find((f) => f.startsWith("#EXT-X-PLAYLIST-TYPE"))) != null ? i : "").split(":")[1]) == null ? void 0 : c.trim(), o = ee$2(n), s = te$2(n), a;
	if (o === L$1.LIVE) {
	...
	if (t === w$1.M3U8) {
		...
		let n = await r.text(), o = await Pt$1(n);
		return {
			...ht$1(n),
			...wt$1(o)
		};
	...
	(i != null && i.URI || i != null && i.VALUE.toLocaleLowerCase().startsWith("http")) && pe$1((c = i.URI) != null ? c : i.VALUE, t), ((d = k$2.get(t)) != null ? d : {}).liveEdgeStartOffset = s, ((f = k$2.get(t)) != null ? f : {}).targetLiveWindow = o, t.dispatchEvent(new CustomEvent("targetlivewindowchange", {
		composed: !0,
		bubbles: !0
	})), ((u = k$2.get(t)) != null ? u : {}).streamType = n, t.dispatchEvent(new CustomEvent("streamtypechange", {
		composed: !0,
		bubbles: !0
	}));
}, pe$1 = async (e, t) => {
	...
	return r === L$1.LIVE && (o = s ? e.partTarget * 2 : e.targetduration * 3), {
		streamType: r,
		targetLiveWindow: n,
	...
	if (n === L$1.LIVE) {
		...
		((u = k$2.get(t)) != null ? u : {}).seekable = M;
	}
	((p = k$2.get(t)) != null ? p : {}).liveEdgeStartOffset = s, ((l = k$2.get(t)) != null ? l : {}).targetLiveWindow = o, t.dispatchEvent(new CustomEvent("targetlivewindowchange", {
		composed: !0,
		bubbles: !0
	})), ((T = k$2.get(t)) != null ? T : {}).streamType = n, t.dispatchEvent(new CustomEvent("streamtypechange", {
		composed: !0,
		bubbles: !0
	}));
}, We, Ve, Je = (Ve = (We = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : We.userAgent) != null ? Ve : "", Fe, Ye, $e, Ot = ($e = (Ye = (Fe = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : Fe.userAgentData) == null ? void 0 : Ye.platform) != null ? $e : "", Ut$1 = Je.toLowerCase().includes("android") || ["x11", "android"].some((e) => Ot.toLowerCase().includes(e)), Ht$1 = (e) => /^((?!chrome|android).)*safari/i.test(Je) && !!e.canPlayType("application/vnd.apple.mpegurl"), k$2 = /* @__PURE__ */ new WeakMap(), A = "mux.com", Be, je, ze$1 = (je = (Be = R$1).isSupported) == null ? void 0 : je.call(Be), Kt$1 = (e) => Ut$1 || !Ht$1(e), Tn = () => {
	if (typeof window != "undefined") return jl.utils.now();
}, Wt = jl.utils.generateUUID, mn = ({ playbackId: e, customDomain: t = A, maxResolution: r, minResolution: n, renditionOrder: o, programStartTime: s, programEndTime: a, assetStartTime: i, assetEndTime: c, playbackToken: d, tokens: { playback: f = d } = {}, extraSourceParams: u = {} } = {}) => {
	if (!e) return;
	let [p, l = ""] = B$2(e), T = new URL(`https://stream.${t}/${p}.m3u8${l}`);
	...
	var t, r, n;
	return (t = e == null ? void 0 : e.metadata) != null && t.video_id ? e.metadata.video_id : tt$1(e) && (n = (r = X$2(e.playbackId)) != null ? r : qe(e.src)) != null ? n : e.src;
}, Ft$1 = (e) => {
	var t;
	...
	var t, r;
	return (r = (t = k$2.get(e)) == null ? void 0 : t.streamType) != null ? r : L$1.UNKNOWN;
}, gn = (e) => {
	var t, r;
...
}, fe$2 = .034, Yt$1 = (e, t, r = fe$2) => Math.abs(e - t) <= r, Xe = (e, t, r = fe$2) => e > t || Yt$1(e, t, r), $t$1 = (e, t = fe$2) => e.paused && Xe(e.currentTime, e.duration, t), Qe = (e, t) => {
	var d, f, u;
	...
	return s > a && s < i;
}, Bt$1 = (e, t) => e.ended || e.loop ? e.ended : t && Qe(e, t) ? !0 : $t$1(e), jt$1 = (e, t, r) => {
	Jt$1(t, r, e);
	let { metadata: n = {} } = e, { view_session_id: o = Wt() } = n, s = Vt$1(e);
	n.view_session_id = o, n.video_id = s, e.metadata = n;
	let a = (p) => {
		var l;
		(l = t.mux) == null || l.emit("hb", { view_drm_type: p });
	};
	e.drmTypeCb = a, e.fallbackToWebkitFairplay = async () => {
		...
		jt$1(e, t, (E = k$2.get(t)) == null ? void 0 : E.coreReference), e.muxDataKeepSession = T, e.useWebkitFairplay = !1, p && await t.play().then(() => {
			t.currentTime = l;
		}).catch(() => {}), t.currentTime = l;
	}, k$2.set(t, { retryCount: 0 });
	let i = zt(e, t), c = ve$1(e, t, i);
	...
	e != null && e.mux && !e.mux.deleted && (r != null && r.muxDataKeepSession ? n && e.mux.removeHLSJS() : (e.mux.destroy(), delete e.mux)), n && (n.detachMedia(), n.destroy()), e && (e.hasAttribute("src") && (e.removeAttribute("src"), e.load()), e.removeEventListener("error", nt$1), e.removeEventListener("error", de$2), e.removeEventListener("durationchange", rt$1), k$2.delete(e), e.dispatchEvent(new Event("teardown")));
};
function Ze(e, t) {
	var d;
	let r = K$2(e);
	if (!(r === w$1.M3U8)) return !0;
	let o = !r || ((d = t.canPlayType(r)) != null ? d : !0), { preferPlayback: s } = e, a = s === Q$1.MSE, i = s === Q$1.NATIVE, c = ze$1 && (a || Kt$1(t));
	return o && (i || !c);
}
var zt = (e, t) => {
	let { debug: r, streamType: n, startTime: o = -1, metadata: s, preferCmcd: a, _hlsConfig: i = {}, maxAutoResolution: c } = e, f = K$2(e) === w$1.M3U8, u = Ze(e, t);
	if (f && !u && ze$1) {
		let p = {
			backBufferLength: 30,
			...
			capLevelOnFPSDrop: !0
		}, l = qt$1(n), T = Gt$1(e), M = [N$1.QUERY, N$1.HEADER].includes(a) ? {
			useHeaders: a === N$1.HEADER,
		...
		return E.capLevelController === z$1 && c !== void 0 && z$1.setMaxAutoResolution(D, c), D.on(R$1.Events.MANIFEST_PARSED, async function(g, b) {
			var h, U;
			let y = (h = b.sessionData) == null ? void 0 : h["com.apple.hls.chapters"];
			(y != null && y.URI || y != null && y.VALUE.toLocaleLowerCase().startsWith("http")) && pe$1((U = y == null ? void 0 : y.URI) != null ? U : y == null ? void 0 : y.VALUE, t);
		}), D;
	}
}, qt$1 = (e) => e === L$1.LIVE ? { backBufferLength: 8 } : {}, Gt$1 = (e) => {
	let { tokens: { drm: t } = {}, playbackId: r, drmTypeCb: n } = e, o = X$2(r);
	return !t || !o ? {} : {
		emeEnabled: !0,
		drmSystems: {
			"com.apple.fps": {
				licenseUrl: G$1(e, "fairplay"),
				serverCertificateUrl: et(e, "fairplay")
			},
			"com.widevine.alpha": { licenseUrl: G$1(e, "widevine") },
			"com.microsoft.playready": { licenseUrl: G$1(e, "playready") }
		},
	...
	let o = {
		...
		getLicenseKey: (s) => Qt$1(s, G$1(e, "fairplay")).catch((a) => {
...
}, G$1 = ({ playbackId: e, tokens: { drm: t } = {}, customDomain: r = A }, n) => {
	let o = X$2(e);
...
}, tt$1 = ({ playbackId: e, src: t, customDomain: r }) => {
	if (e) return !0;
	...
	let r = {};
	return r.capLevelToPlayerSize = e.capRenditionToPlayerSize, r.capLevelToPlayerSize == null ? (r.capLevelController = z$1, r.capLevelToPlayerSize = !0) : r.capLevelController = CapLevelController, r;
}, tr = (e, t, r) => {
	var c;
	let { envKey: n, disableTracking: o, muxDataSDK: s = jl, muxDataSDKOptions: a = {} } = e, i = tt$1(e);
	if (!o && (n || i)) {
	...
	let n = Ze(e, t), { src: o, customDomain: s = A } = e, a = () => {
		t.ended || e.disablePseudoEnded || !Bt$1(t, r) || (Qe(t, r) ? t.currentTime = t.buffered.end(t.buffered.length - 1) : t.dispatchEvent(new Event("ended")));
	}, i, c, d = () => {
		let p = Ge(t), l, T;
		p.length > 0 && (l = p.start(0), T = p.end(0)), (c !== T || i !== l) && t.dispatchEvent(new CustomEvent("seekablechange", { composed: !0 })), i = l, c = T;
	};
	if (P$2(t, "durationchange", d), t && n) {
		let p = K$2(e);
		if (typeof o == "string") {
			if (o.endsWith(".mp4") && o.includes(s)) {
				let M = qe(o);
				pe$1(new URL(`https://stream.${s}/${M}/metadata.json`).toString(), t);
			}
			let l = () => {
				if (Ke(t) !== L$1.LIVE || Number.isFinite(t.duration)) return;
			...
			}, T = async () => St$1(o, t, p).then(l).catch((M) => {
				if (M instanceof Response) {
					let E = W(M, v$1.VIDEO, e);
					if (E) {
						I$2(t, E);
						return;
					}
			...
			(f = e.tokens) != null && f.drm ? Zt$1(e, t) : P$2(t, "encrypted", () => {
				let E = new m(x$4("Attempting to play DRM-protected content without providing a DRM token."), m.MEDIA_ERR_ENCRYPTED, !0);
				E.errorCategory = v$1.DRM, E.muxCode = C$3.ENCRYPTED_MISSING_TOKEN, I$2(t, E);
			}, { once: !0 }), t.setAttribute("src", o), e.startTime && (((u = k$2.get(t)) != null ? u : {}).startTime = e.startTime, t.addEventListener("durationchange", rt$1, { once: !0 }));
		} else t.removeAttribute("src");
		t.addEventListener("error", nt$1), t.addEventListener("error", de$2), t.addEventListener("emptied", () => {
	...
	} else r && o ? (r.once(R$1.Events.LEVEL_LOADED, (p, l) => {
		Nt$1(l.details, t, r), d(), Ke(t) === L$1.LIVE && !Number.isFinite(t.duration) && (r.on(R$1.Events.LEVEL_UPDATED, d), P$2(t, "durationchange", () => {
			Number.isFinite(t.duration) && r.off(R$1.Events.LEVELS_UPDATED, d);
		}));
	}), r.on(R$1.Events.ERROR, (p, l) => {
		var M, E;
		let T = nr(l, e);
		if (T.muxCode === C$3.NETWORK_NOT_READY) {
			...
			if (b < 6) {
				...
				Object.assign(h, T), I$2(t, h), setTimeout(() => {
	...
	}), t.addEventListener("error", de$2), P$2(t, "waiting", a), De(e, r), ke$1(t, r), r.attachMedia(t)) : console.error("It looks like the video you're trying to play will not work on this system! If possible, try upgrading to the newest versions of your browser or software.");
};
function rt$1(e) {
	var n;
...
var nr = (e, t) => {
	...
	}, o = (u) => [R$1.ErrorDetails.KEY_SYSTEM_LICENSE_REQUEST_FAILED, R$1.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_REQUEST_FAILED].includes(u.details) ? m.MEDIA_ERR_NETWORK : n[u.type], s = (u) => {
		if (u.type === R$1.ErrorTypes.KEY_SYSTEM_ERROR) return v$1.DRM;
		if (u.type === R$1.ErrorTypes.NETWORK_ERROR) return v$1.VIDEO;
	}, a, i = o(e);
	if (i === m.MEDIA_ERR_NETWORK && e.response) {
		let u = (c = s(e)) != null ? c : v$1.VIDEO;
		a = (d = W(e.response, u, t, e.fatal)) != null ? d : new m("", i, e.fatal);
	} else if (i === m.MEDIA_ERR_ENCRYPTED) if (e.details === R$1.ErrorDetails.KEY_SYSTEM_NO_CONFIGURED_LICENSE) a = new m(x$4("Attempting to play DRM-protected content without providing a DRM token."), m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_MISSING_TOKEN;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_NO_ACCESS) a = new m(x$4("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser."), m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_NO_SESSION) a = new m(x$4("Failed to generate a DRM license request. This may be an issue with the player or your protected content."), m.MEDIA_ERR_ENCRYPTED, !0), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_GENERATE_REQUEST_FAILED;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_SESSION_UPDATE_FAILED) a = new m(x$4("Failed to update DRM license. This may be an issue with the player or your protected content."), m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_UPDATE_LICENSE_FAILED;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_UPDATE_FAILED) a = new m(x$4("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate."), m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_UPDATE_SERVER_CERT_FAILED;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_STATUS_INTERNAL_ERROR) a = new m(x$4("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser."), m.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_CDM_ERROR;
	else if (e.details === R$1.ErrorDetails.KEY_SYSTEM_STATUS_OUTPUT_RESTRICTED) a = new m(x$4("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen."), m.MEDIA_ERR_ENCRYPTED, !1), a.errorCategory = v$1.DRM, a.muxCode = C$3.ENCRYPTED_OUTPUT_RESTRICTED;
...
var L = (n, a, e) => a.has(n) || C$2("Cannot " + e);
var s$2 = (n, a, e) => (L(n, a, "read from private field"), e ? e.call(n) : a.get(n)), d$2 = (n, a, e) => a.has(n) ? C$2("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(n) : a.set(n, e), l$1 = (n, a, e, i) => (L(n, a, "write to private field"), i ? i.call(n, e) : a.set(n, e), e), T$1 = (n, a, e) => (L(n, a, "access private method"), e);
var Y = () => {
	try {
		return "0.30.3";
	} catch {}
...
var t$1 = {
...
}, ue$1 = Object.values(t$1), x$3 = D$1(), K$1 = "mux-video", g$4, _, c$2, p$4, O, R, I$1, M$2, m$5, o$2, f$3, y$3, b$2, B$1 = class extends CustomVideoElement {
	constructor() {
		super();
		d$2(this, o$2);
		d$2(this, g$4);
		...
		d$2(this, m$5, "");
		d$2(this, y$3);
		l$1(this, _, Tn()), this.nativeEl.addEventListener("muxmetadata", (e) => {
			var E;
			let i = En$1(this.nativeEl), r = (E = this.metadata) != null ? E : {};
			this.metadata = {
				...i,
				...r
			}, (i == null ? void 0 : i["com.mux.video.branding"]) === "mux-free-plan" && (l$1(this, m$5, "default"), this.updateLogo());
		});
	}
	static get NAME() {
		return K$1;
	...
	static get observedAttributes() {
		var e;
		return [...ue$1, ...(e = CustomVideoElement.observedAttributes) != null ? e : []];
	}
	static getLogoHTML(e) {
		return !e || e === "false" ? "" : e === "default" ? k$1 : `<img part="logo" src="${e}" />`;
	}
	...
	get playerInitTime() {
		return this.hasAttribute(t$1.PLAYER_INIT_TIME) ? +this.getAttribute(t$1.PLAYER_INIT_TIME) : s$2(this, _);
	}
	...
	get playerSoftwareName() {
		var e;
		return (e = s$2(this, I$1)) != null ? e : K$1;
	}
	...
	get playerSoftwareVersion() {
		var e;
		return (e = s$2(this, R)) != null ? e : x$3;
	}
	...
	get _hls() {
		var e;
		return (e = s$2(this, o$2, f$3)) == null ? void 0 : e.engine;
	}
	get mux() {
		var e;
	...
	get currentPdt() {
		return Tt(this.nativeEl, this._hls);
	}
	get preferPlayback() {
	...
	set metadata(e) {
		l$1(this, c$2, e != null ? e : {}), this.mux && this.mux.emit("hb", s$2(this, c$2));
	}
	get _hlsConfig() {
		return s$2(this, O);
	}
	...
	load() {
		jt$1(this, this.nativeEl, s$2(this, o$2, f$3));
	}
	unload() {
		Jt$1(this.nativeEl, s$2(this, o$2, f$3), this);
	}
	attributeChangedCallback(e, i, r) {
		...
		switch (CustomVideoElement.observedAttributes.includes(e) && ![
			...
			case "src": {
				let u = !!i, h = !!r;
				!u && h ? T$1(this, o$2, b$2).call(this) : u && !h ? this.unload() : u && h && (this.unload(), T$1(this, o$2, b$2).call(this));
				break;
			}
			case "autoplay":
				if (r === i) break;
				(A = s$2(this, o$2, f$3)) == null || A.setAutoplay(this.autoplay);
				break;
			case "preload":
				if (r === i) break;
				(P = s$2(this, o$2, f$3)) == null || P.setPreload(r);
				break;
			...
			case t$1.DISABLE_TRACKING:
				if (r == null || r !== i) {
					...
					this.unload(), T$1(this, o$2, b$2).call(this).then(() => {
	...
	connectedCallback() {
		var e;
		(e = super.connectedCallback) == null || e.call(this), this.nativeEl && this.src && !s$2(this, o$2, f$3) && T$1(this, o$2, b$2).call(this);
	}
...
g$4 = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), c$2 = /* @__PURE__ */ new WeakMap(), p$4 = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), I$1 = /* @__PURE__ */ new WeakMap(), M$2 = /* @__PURE__ */ new WeakMap(), m$5 = /* @__PURE__ */ new WeakMap(), o$2 = /* @__PURE__ */ new WeakSet(), f$3 = function() {
	return bn(this.nativeEl);
}, y$3 = /* @__PURE__ */ new WeakMap(), b$2 = async function() {
	s$2(this, g$4) || (await l$1(this, g$4, Promise.resolve()), l$1(this, g$4, null), this.load());
};
//#endregion
...
var g$3 = (e, o, t) => o.has(e) || f$2("Cannot " + t);
var u$2 = (e, o, t) => (g$3(e, o, "read from private field"), t ? t.call(e) : o.get(e)), m$4 = (e, o, t) => o.has(e) ? f$2("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(e) : o.set(e, t), d$1 = (e, o, t, l) => (g$3(e, o, "write to private field"), l ? l.call(e, t) : o.set(e, t), t);
var s$1 = class {
	addEventListener() {}
	removeEventListener() {}
	dispatchEvent(o) {
...
var n = class extends s$1 {}, p$3 = class extends s$1 {}, x$2 = {
	get(e) {},
	define(e, o, t) {},
	getName(e) {
		return null;
...
var r$2, i = class extends CastableMediaMixin(MediaTracksMixin(B$1)) {
	constructor() {
		super(...arguments);
		m$4(this, r$2);
	}
	...
	get castCustomData() {
		var t;
		return (t = u$2(this, r$2)) != null ? t : this.muxCastCustomData;
	}
...
var MediaGestureReceiver = class extends GlobalThis.HTMLElement {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		...
		if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
			if (oldValue) {
				(_b = (_a = __privateGet$29(this, _mediaController$7)) == null ? void 0 : _a.unassociateElement) == null || _b.call(_a, this);
			...
			if (newValue && this.isConnected) {
				...
				(_e = (_d = __privateGet$29(this, _mediaController$7)) == null ? void 0 : _d.associateElement) == null || _e.call(_d, this);
			}
		}
	}
	connectedCallback() {
		...
		if (this.getAttribute(MediaStateReceiverAttributes.MEDIA_CONTROLLER)) (_b = (_a = __privateGet$29(this, _mediaController$7)) == null ? void 0 : _a.associateElement) == null || _b.call(_a, this);
	...
	disconnectedCallback() {
		var _a, _b, _c, _d;
		if (this.getAttribute(MediaStateReceiverAttributes.MEDIA_CONTROLLER)) (_b = (_a = __privateGet$29(this, _mediaController$7)) == null ? void 0 : _a.unassociateElement) == null || _b.call(_a, this);
...
var AttributeTokenList = class {
	...
	get value() {
		var _a;
		return (_a = [...__privateGet$27(this, _tokens, tokens_get)].join(" ")) != null ? _a : "";
	}
	set value(val) {
		var _a;
	...
	add(...tokens) {
		var _a, _b;
		tokens.forEach((t) => __privateGet$27(this, _tokenSet).add(t));
		if (this.value === "" && !((_a = __privateGet$27(this, _el)) == null ? void 0 : _a.hasAttribute(`${__privateGet$27(this, _attr)}`))) return;
		(_b = __privateGet$27(this, _el)) == null || _b.setAttribute(`${__privateGet$27(this, _attr)}`, `${this.value}`);
	}
	remove(...tokens) {
		var _a;
		tokens.forEach((t) => __privateGet$27(this, _tokenSet).delete(t));
		(_a = __privateGet$27(this, _el)) == null || _a.setAttribute(`${__privateGet$27(this, _attr)}`, `${this.value}`);
	}
	contains(token) {
	...
	mediaIsFullscreen: {
		...
		set(value, stateOwners, event) {
			...
			if (!value) exitFullscreen(stateOwners);
				...
				if (event.detail) (_a = stateOwners.media) == null || _a.focus();
			}
		},
...
var MediaController = class extends MediaContainer {
	constructor() {
		...
		__privateAdd$26(this, _hotKeys, new AttributeTokenList(this, Attributes$12.HOTKEYS));
		...
		__privateAdd$26(this, _mediaStateEventHandler, (event) => {
			var _a;
			(_a = __privateGet$26(this, _mediaStore)) == null || _a.dispatch(event);
		});
	...
	static get observedAttributes() {
		return super.observedAttributes.concat(Attributes$12.NO_HOTKEYS, Attributes$12.HOTKEYS, Attributes$12.DEFAULT_STREAM_TYPE, Attributes$12.DEFAULT_SUBTITLES, Attributes$12.DEFAULT_DURATION, Attributes$12.NO_MUTED_PREF, Attributes$12.NO_VOLUME_PREF, Attributes$12.LANG, Attributes$12.LOOP);
	}
	get mediaStore() {
	...
	set mediaStore(value) {
		...
		if (__privateGet$26(this, _mediaStore)) {
			(_a = __privateGet$26(this, _mediaStoreUnsubscribe)) == null || _a.call(this);
			__privateSet$23(this, _mediaStoreUnsubscribe, void 0);
		}
		__privateSet$23(this, _mediaStore, value);
		if (!__privateGet$26(this, _mediaStore) && !this.hasAttribute(Attributes$12.NO_DEFAULT_STORE)) {
	...
	get fullscreenElement() {
		var _a;
		return (_a = __privateGet$26(this, _fullscreenElement)) != null ? _a : this;
	}
	set fullscreenElement(element) {
		...
		(_a = __privateGet$26(this, _mediaStore)) == null || _a.dispatch({
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		...
		if (attrName === Attributes$12.NO_HOTKEYS) {
		...
		} else if (attrName === Attributes$12.HOTKEYS) __privateGet$26(this, _hotKeys).value = newValue;
		else if (attrName === Attributes$12.DEFAULT_SUBTITLES && newValue !== oldValue) (_a = __privateGet$26(this, _mediaStore)) == null || _a.dispatch({
			type: "optionschangerequest",
			detail: { defaultSubtitles: this.hasAttribute(Attributes$12.DEFAULT_SUBTITLES) }
		});
		else if (attrName === Attributes$12.DEFAULT_STREAM_TYPE) (_c = __privateGet$26(this, _mediaStore)) == null || _c.dispatch({
			type: "optionschangerequest",
			detail: { defaultStreamType: (_b = this.getAttribute(Attributes$12.DEFAULT_STREAM_TYPE)) != null ? _b : void 0 }
		});
		else if (attrName === Attributes$12.LIVE_EDGE_OFFSET) (_d = __privateGet$26(this, _mediaStore)) == null || _d.dispatch({
			type: "optionschangerequest",
			detail: {
				liveEdgeOffset: this.hasAttribute(Attributes$12.LIVE_EDGE_OFFSET) ? +this.getAttribute(Attributes$12.LIVE_EDGE_OFFSET) : void 0,
				seekToLiveOffset: !this.hasAttribute(Attributes$12.SEEK_TO_LIVE_OFFSET) ? +this.getAttribute(Attributes$12.LIVE_EDGE_OFFSET) : void 0
			}
		});
		else if (attrName === Attributes$12.SEEK_TO_LIVE_OFFSET) (_e = __privateGet$26(this, _mediaStore)) == null || _e.dispatch({
			type: "optionschangerequest",
			detail: { seekToLiveOffset: this.hasAttribute(Attributes$12.SEEK_TO_LIVE_OFFSET) ? +this.getAttribute(Attributes$12.SEEK_TO_LIVE_OFFSET) : void 0 }
		});
		else if (attrName === Attributes$12.NO_AUTO_SEEK_TO_LIVE) (_f = __privateGet$26(this, _mediaStore)) == null || _f.dispatch({
			type: "optionschangerequest",
			...
			(_i = __privateGet$26(this, _mediaStore)) == null || _i.dispatch({
				type: "optionschangerequest",
				detail: { mediaLang: newValue }
			});
		} else if (attrName === Attributes$12.LOOP && newValue !== oldValue) (_j = __privateGet$26(this, _mediaStore)) == null || _j.dispatch({
			type: MediaUIEvents.MEDIA_LOOP_REQUEST,
			detail: newValue != null
		});
		else if (attrName === Attributes$12.NO_VOLUME_PREF && newValue !== oldValue) (_k = __privateGet$26(this, _mediaStore)) == null || _k.dispatch({
			type: "optionschangerequest",
			detail: { noVolumePref: this.hasAttribute(Attributes$12.NO_VOLUME_PREF) }
		});
		else if (attrName === Attributes$12.NO_MUTED_PREF && newValue !== oldValue) (_l = __privateGet$26(this, _mediaStore)) == null || _l.dispatch({
			type: "optionschangerequest",
	...
	connectedCallback() {
		var _a, _b;
		if (!__privateGet$26(this, _mediaStore) && !this.hasAttribute(Attributes$12.NO_DEFAULT_STORE)) __privateMethod$12(this, _setupDefaultStore, setupDefaultStore_fn).call(this);
		(_a = __privateGet$26(this, _mediaStore)) == null || _a.dispatch({
	...
	disconnectedCallback() {
		...
		if (__privateGet$26(this, _mediaStoreUnsubscribe)) {
			(_e = __privateGet$26(this, _mediaStoreUnsubscribe)) == null || _e.call(this);
			__privateSet$23(this, _mediaStoreUnsubscribe, void 0);
		}
	}
	/**
	...
	*/
	...
	get hotkeys() {
		return getStringAttr(this, Attributes$12.HOTKEYS);
	}
	set hotkeys(value) {
	...
	keyboardShortcutHandler(e) {
		...
		if (__privateGet$26(this, _hotKeys).contains(`no${e.key.toLowerCase()}`)) return;
		if (e.key === " " && __privateGet$26(this, _hotKeys).contains(`nospace`)) return;
		if (e.shiftKey && (e.key === "/" || e.key === "?") && __privateGet$26(this, _hotKeys).contains("noshift+/")) return;
		switch (e.key) {
			case " ":
			case "k":
			...
			case "/":
			case "?":
				if (e.shiftKey) __privateMethod$12(this, _showKeyboardShortcutsDialog, showKeyboardShortcutsDialog_fn).call(this);
				break;
			case "p":
...
keyDownHandler_fn = function(e) {
	...
	if (isShiftSlash && ((_a = __privateGet$26(this, _keyboardShortcutsDialog)) == null ? void 0 : _a.open)) {
		this.removeEventListener("keyup", __privateMethod$12(this, _keyUpHandler, keyUpHandler_fn));
		return;
	}
	...
	if ([
		...
		"ArrowUp",
		"ArrowDown"
	].includes(key) && !(__privateGet$26(this, _hotKeys).contains(`no${key.toLowerCase()}`) || key === " " && __privateGet$26(this, _hotKeys).contains("nospace")) && !isRangeInput) e.preventDefault();
...
var MediaChromeButton = class extends GlobalThis.HTMLElement {
	constructor() {
		...
		this.tooltipEl = null;
		__privateAdd$25(this, _clickListener, (e) => {
		...
		__privateAdd$25(this, _keyupListener, (e) => {
			const { key } = e;
		...
		__privateAdd$25(this, _keydownListener, (e) => {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		...
		if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
			if (oldValue) {
				(_b = (_a = __privateGet$25(this, _mediaController$6)) == null ? void 0 : _a.unassociateElement) == null || _b.call(_a, this);
			...
			if (newValue && this.isConnected) {
				...
				(_e = (_d = __privateGet$25(this, _mediaController$6)) == null ? void 0 : _d.associateElement) == null || _e.call(_d, this);
			}
...
var MediaChromeDialog = class extends GlobalThis.HTMLElement {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		__privateMethod$10(this, _init, init_fn).call(this);
		if (attrName === Attributes$9.OPEN && newValue !== oldValue) if (this.open) __privateMethod$10(this, _handleOpen$1, handleOpen_fn$1).call(this);
...
handleOpen_fn$1 = function() {
	var _a;
	(_a = __privateGet$24(this, _invokerElement$1)) == null || _a.setAttribute("aria-expanded", "true");
...
handleClosed_fn$1 = function() {
	var _a;
	(_a = __privateGet$24(this, _invokerElement$1)) == null || _a.setAttribute("aria-expanded", "false");
...
handleFocusOut_fn$1 = function(event) {
	...
	if (!containsComposedNode(this, event.relatedTarget)) {
		(_a = __privateGet$24(this, _previouslyFocused$1)) == null || _a.focus();
...
handleKeyDown_fn$2 = function(event) {
	...
	if (key === "Tab") {
		...
		(_e = __privateGet$24(this, _previouslyFocused$1)) == null || _e.focus();
		this.open = false;
	}
};
...
var MediaChromeRange = class extends GlobalThis.HTMLElement {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		...
		if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
			if (oldValue) {
				(_b = (_a = __privateGet$23(this, _mediaController$5)) == null ? void 0 : _a.unassociateElement) == null || _b.call(_a, this);
			...
			if (newValue && this.isConnected) {
				...
				(_e = (_d = __privateGet$23(this, _mediaController$5)) == null ? void 0 : _d.associateElement) == null || _e.call(_d, this);
			}
	...
	updatePointerBar(evt) {
		var _a;
		(_a = __privateGet$23(this, _cssRules).pointer) == null || _a.style.setProperty("width", `${this.getPointerRatio(evt) * 100}%`);
	}
	updateBar() {
		var _a, _b;
		const rangePercent = this.range.valueAsNumber * 100;
		(_a = __privateGet$23(this, _cssRules).progress) == null || _a.style.setProperty("width", `${rangePercent}%`);
...
updateActiveSegment_fn = function(evt) {
	...
	const selectorText = `#segments-clipping rect:nth-child(${__privateGet$23(this, _segments).findIndex((start, i, arr) => {
		const end = arr[i + 1];
...
handlePointerDown_fn = function(evt) {
	...
	(_a = GlobalThis.window) == null || _a.addEventListener("pointerup", this);
};
...
var MediaControlBar = class extends GlobalThis.HTMLElement {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		...
		if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
			if (oldValue) {
				(_b = (_a = __privateGet$22(this, _mediaController$4)) == null ? void 0 : _a.unassociateElement) == null || _b.call(_a, this);
			...
			if (newValue && this.isConnected) {
				...
				(_e = (_d = __privateGet$22(this, _mediaController$4)) == null ? void 0 : _d.associateElement) == null || _e.call(_d, this);
			}
		}
	}
	connectedCallback() {
...
var MediaTextDisplay = class extends GlobalThis.HTMLElement {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		...
		if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
			if (oldValue) {
				(_b = (_a = __privateGet$21(this, _mediaController$3)) == null ? void 0 : _a.unassociateElement) == null || _b.call(_a, this);
			...
			if (newValue && this.isConnected) {
				...
				(_e = (_d = __privateGet$21(this, _mediaController$3)) == null ? void 0 : _d.associateElement) == null || _e.call(_d, this);
			}
		}
	}
	connectedCallback() {
...
var MediaDurationDisplay = class extends MediaTextDisplay {
	constructor() {
		...
		__privateGet$20(this, _slot$3).textContent = formatTime((_a = this.mediaDuration) != null ? _a : 0);
	}
	static get observedAttributes() {
...
var MediaKeyboardShortcutsDialog = class extends MediaChromeDialog {
	constructor() {
		super(...arguments);
		__privateAdd$18(this, _clickHandler, (e) => {
			var _a;
			if (!this.open) return;
		...
		__privateAdd$18(this, _keyDownHandler, (e) => {
			if (!this.open) return;
...
var MediaLoadingIndicator = class extends GlobalThis.HTMLElement {
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		...
		if (attrName === Attributes$8.LOADING_DELAY && oldValue !== newValue) this.loadingDelay = Number(newValue);
			...
			if (oldValue) {
				(_b = (_a = __privateGet$16(this, _mediaController$2)) == null ? void 0 : _a.unassociateElement) == null || _b.call(_a, this);
			...
			if (newValue && this.isConnected) {
				...
				(_e = (_d = __privateGet$16(this, _mediaController$2)) == null ? void 0 : _d.associateElement) == null || _e.call(_d, this);
			}
		}
	}
	connectedCallback() {
...
var MediaPlaybackRateButton = class extends MediaChromeButton {
	constructor() {
		var _a;
		super();
		__privateAdd$15(this, _rates$1, new AttributeTokenList(this, Attributes$7.RATES, { defaultValue: DEFAULT_RATES }));
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		super.attributeChangedCallback(attrName, oldValue, newValue);
		if (attrName === Attributes$7.RATES) __privateGet$15(this, _rates$1).value = newValue;
	...
	*/
	...
	handleClick() {
		var _a, _b;
		const availableRates = Array.from(__privateGet$15(this, _rates$1).values(), (str) => +str).sort((a, b) => a - b);
...
var MediaPreviewThumbnail = class extends GlobalThis.HTMLElement {
	...
	disconnectedCallback() {
		var _a, _b;
		(_b = (_a = __privateGet$13(this, _mediaController$1)) == null ? void 0 : _a.unassociateElement) == null || _b.call(_a, this);
	...
	attributeChangedCallback(attrName, oldValue, newValue) {
		...
		if (attrName === MediaStateReceiverAttributes.MEDIA_CONTROLLER) {
			...
			if (newValue && this.isConnected) {
				...
				(_e = (_d = __privateGet$13(this, _mediaController$1)) == null ? void 0 : _d.associateElement) == null || _e.call(_d, this);
			}
		}
	}
	/**
	...
	constructor(range, callback, fps) {
		...
		__privateAdd$10(this, _animate, (now = performance.now()) => {
			...
			if (__privateGet$10(this, _deltaTime) > fpsInterval) {
				...
				const fps = 1e3 / ((now - __privateGet$10(this, _startTime)) / ++__privateWrapper(this, _frameCount)._);
				...
				if (value - __privateGet$10(this, _range).valueAsNumber > 0) __privateSet$9(this, _lastRangeIncrease, this.playbackRate / this.duration / fps);
				else {
...
var MediaTimeRange = class extends MediaChromeRange {
	...
	connectedCallback() {
		...
		(_a = __privateGet$9(this, _rootNode)) == null || _a.addEventListener("transitionstart", this);
	}
	disconnectedCallback() {
		var _a;
		super.disconnectedCallback();
		__privateMethod$8(this, _toggleRangeAnimation, toggleRangeAnimation_fn).call(this);
		(_a = __privateGet$9(this, _rootNode)) == null || _a.removeEventListener("transitionstart", this);
	...
	set mediaChaptersCues(value) {
		...
		this.updateSegments((_a = __privateGet$9(this, _mediaChaptersCues)) == null ? void 0 : _a.map((c) => ({
...
handlePointerMove_fn = function(evt) {
	const isOverBoxes = [...__privateGet$9(this, _boxes)].some((b) => evt.composedPath().includes(b));
...
var u$1 = (t, a, e) => (he(t, a, "read from private field"), e ? e.call(t) : a.get(t)), v = (t, a, e) => a.has(t) ? tt("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(t) : a.set(t, e), C = (t, a, e, i) => (he(t, a, "write to private field"), i ? i.call(t, e) : a.set(t, e), e), p$2 = (t, a, e) => (he(t, a, "access private method"), e);
var F = class {
	addEventListener() {}
	removeEventListener() {}
	dispatchEvent(a) {
...
var G = class extends F {}, ge = class extends F {}, Bt = {
	get(t) {},
	define(t, a, e) {},
	getName(t) {
		return null;
...
var nt = "mux.com", $t = () => {
	...
	return "UNKNOWN";
}, Ft = $t(), se$1 = () => Ft, st = (t, { token: a, customDomain: e = nt, thumbnailTime: i, programTime: r } = {}) => {
	var l;
	let n = a == null ? i : void 0, { aud: d } = (l = re$2(a)) != null ? l : {};
	if (!(a && d !== "t")) return `https://image.${e}/${t}/thumbnail.webp${ye$1({
		token: a,
		time: n,
		program_time: r
	})}`;
	...
	if (!(a && n !== "s")) return `https://image.${e}/${t}/storyboard.vtt${ye$1({
		token: a,
		format: "webp",
	...
	if (t) {
		if ([L$1.LIVE, L$1.ON_DEMAND].includes(t)) return t;
		if (t != null && t.includes("live")) return L$1.LIVE;
	}
};
var Yt = {
...
function lt(t) {
	var a;
	return (a = Yt[t]) != null ? a : oe$1(t);
}
var D, U, T, ne$1 = class {
	constructor(a, e) {
		v(this, D);
		v(this, U);
		v(this, T, []);
	...
	[Symbol.iterator]() {
		return u$1(this, T).values();
	}
	get length() {
		return u$1(this, T).length;
	}
	get value() {
		var a;
		return (a = u$1(this, T).join(" ")) != null ? a : "";
	}
	set value(a) {
		var e;
	...
	keys() {
		return u$1(this, T).keys();
	}
	forEach(a) {
		u$1(this, T).forEach(a);
	}
	add(...a) {
		var e, i;
		a.forEach((r) => {
			this.contains(r) || u$1(this, T).push(r);
		}), !(this.value === "" && !((e = u$1(this, D)) != null && e.hasAttribute(`${u$1(this, U)}`))) && ((i = u$1(this, D)) == null || i.setAttribute(`${u$1(this, U)}`, `${this.value}`));
	}
	remove(...a) {
		var e;
		a.forEach((i) => {
			u$1(this, T).splice(u$1(this, T).indexOf(i), 1);
		}), (e = u$1(this, D)) == null || e.setAttribute(`${u$1(this, U)}`, `${this.value}`);
	}
	contains(a) {
		return u$1(this, T).includes(a);
	}
	toggle(a, e) {
...
D = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), T = /* @__PURE__ */ new WeakMap();
var ut = `[mux-player ${se$1()}]`;
function x$1(...t) {
	console.warn(ut, ...t);
}
function E$2(...t) {
...
function ve(t) {
	...
	t.context && (a += ` ${t.context}`), t.file && (a += ` ${x$4("Read more: ")}
https://github.com/muxinc/elements/blob/main/errors/${t.file}`), x$1(a);
}
var g$2 = {
	AUTOPLAY: "autoplay",
	CROSSORIGIN: "crossorigin",
...
var ct = Object.freeze({
...
}), Zt = Object.values(g$2).filter((t) => g$2.PLAYSINLINE !== t), Gt = Object.values(N), jt = [...Zt, ...Gt], Ae = class extends k.HTMLElement {
	static get observedAttributes() {
		return jt;
	}
	constructor() {
	...
	attributeChangedCallback(a, e, i) {
		...
		switch (a) {
			case N.MUTED:
				...
				return;
			case N.VOLUME: {
				let d = (r = y$1(i)) != null ? r : 1;
				this.media && (this.media.volume = d);
				return;
			}
			case N.PLAYBACKRATE: {
				let d = (n = y$1(i)) != null ? n : 1;
	...
	get defaultPlaybackRate() {
		var a;
		return (a = y$1(this.getAttribute(N.PLAYBACKRATE))) != null ? a : 1;
	}
	set defaultPlaybackRate(a) {
		a != null ? this.setAttribute(N.PLAYBACKRATE, `${a}`) : this.removeAttribute(N.PLAYBACKRATE);
	}
	get crossOrigin() {
		return X$1(this, g$2.CROSSORIGIN);
	}
	set crossOrigin(a) {
		this.setAttribute(g$2.CROSSORIGIN, `${a}`);
	}
	get autoplay() {
		return X$1(this, g$2.AUTOPLAY) != null;
	}
	set autoplay(a) {
		a ? this.setAttribute(g$2.AUTOPLAY, typeof a == "string" ? a : "") : this.removeAttribute(g$2.AUTOPLAY);
	}
	get loop() {
		return X$1(this, g$2.LOOP) != null;
	}
	set loop(a) {
		a ? this.setAttribute(g$2.LOOP, "") : this.removeAttribute(g$2.LOOP);
	}
	get muted() {
		var a, e;
	...
	get defaultMuted() {
		return X$1(this, g$2.MUTED) != null;
	}
	set defaultMuted(a) {
		a ? this.setAttribute(g$2.MUTED, "") : this.removeAttribute(g$2.MUTED);
	}
	get playsInline() {
		return X$1(this, g$2.PLAYSINLINE) != null;
	}
	set playsInline(a) {
	...
	set preload(a) {
		[
			...
			"metadata",
			"auto"
		].includes(a) ? this.setAttribute(g$2.PRELOAD, a) : this.removeAttribute(g$2.PRELOAD);
	}
};
function X$1(t, a) {
...
`;
var q = /* @__PURE__ */ new WeakMap(), _e = class t {
	constructor(a, e) {
		this.element = a;
		this.type = e;
...
function qt(t, a) {
	return t instanceof AttrPart && t.attributeName.startsWith("on") ? (_e.for(t).set(a), t.element.removeAttributeNS(t.attributeNamespace, t.attributeName), !0) : !1;
}
function Qt(t, a) {
	return a instanceof de$1 && t instanceof ChildNodePart ? (a.renderInto(t), !0) : !1;
}
function Jt(t, a) {
...
var ke = /* @__PURE__ */ new Map(), bt = /* @__PURE__ */ new WeakMap(), ht = /* @__PURE__ */ new WeakMap(), de$1 = class {
	constructor(a, e, i) {
		this.strings = a;
		this.values = e;
		this.processor = i;
	...
	renderInto(a) {
		...
		if (bt.get(a) !== e) {
			...
			ht.set(a, n), a instanceof ChildNodePart ? a.replace(...n.children) : a.appendChild(n);
			return;
		}
		let i = ht.get(a);
		(r = i == null ? void 0 : i.update) == null || r.call(i, this.values);
	}
}, oa = { processCallback(t, a, e) {
	var i;
	if (e) {
		for (let [r, n] of a) if (r in e) ra(n, (i = e[r]) != null ? i : "");
	}
} };
function Q(t, ...a) {
	return new de$1(t, a, oa);
}
function gt(t, a) {
	t.renderInto(a);
}
...
`, da = (t) => {
  ...
  <media-theme
    ...
    noautoseektolive="${!!((e = t.streamType) != null && e.includes(L$1.LIVE)) && t.targetLiveWindow !== 0}"
...
var vt = (t) => t.charAt(0).toUpperCase() + t.slice(1), ca = (t, a = !1) => {
	var e, i;
	if (t.muxCode) {
		let r = vt((e = t.errorCategory) != null ? e : "video"), n = V$1((i = t.errorCategory) != null ? i : v$1.VIDEO);
		if (t.muxCode === C$3.NETWORK_OFFLINE) return x$4("Your device appears to be offline", a);
		if (t.muxCode === C$3.NETWORK_TOKEN_EXPIRED) return x$4("{category} URL has expired", a).format({ category: r });
		if ([
			C$3.NETWORK_TOKEN_SUB_MISMATCH,
			C$3.NETWORK_TOKEN_AUD_MISMATCH,
			C$3.NETWORK_TOKEN_AUD_MISSING,
			C$3.NETWORK_TOKEN_MALFORMED
		].includes(t.muxCode)) return x$4("{category} URL is formatted incorrectly", a).format({ category: r });
		if (t.muxCode === C$3.NETWORK_TOKEN_MISSING) return x$4("Invalid {categoryName} URL", a).format({ categoryName: n });
		if (t.muxCode === C$3.NETWORK_NOT_FOUND) return x$4("{category} does not exist", a).format({ category: r });
		if (t.muxCode === C$3.NETWORK_NOT_READY) {
			let d = t.streamType === "live" ? "Live stream" : "Video";
			return x$4("{mediaType} is not currently available", a).format({ mediaType: d });
		}
	}
	if (t.code) {
		if (t.code === m.MEDIA_ERR_NETWORK) return x$4("Network Error", a);
		if (t.code === m.MEDIA_ERR_DECODE) return x$4("Media Error", a);
		if (t.code === m.MEDIA_ERR_SRC_NOT_SUPPORTED) return x$4("Source Not Supported", a);
	}
	return x$4("Error", a);
}, pa = (t, a = !1) => {
	var e, i;
	if (t.muxCode) {
		let r = vt((e = t.errorCategory) != null ? e : "video"), n = V$1((i = t.errorCategory) != null ? i : v$1.VIDEO);
		return t.muxCode === C$3.NETWORK_OFFLINE ? x$4("Check your internet connection and try reloading this video.", a) : t.muxCode === C$3.NETWORK_TOKEN_EXPIRED ? x$4("The video’s secured {tokenNamePrefix}-token has expired.", a).format({ tokenNamePrefix: n }) : t.muxCode === C$3.NETWORK_TOKEN_SUB_MISMATCH ? x$4("The video’s playback ID does not match the one encoded in the {tokenNamePrefix}-token.", a).format({ tokenNamePrefix: n }) : t.muxCode === C$3.NETWORK_TOKEN_MALFORMED ? x$4("{category} URL is formatted incorrectly", a).format({ category: r }) : [C$3.NETWORK_TOKEN_AUD_MISMATCH, C$3.NETWORK_TOKEN_AUD_MISSING].includes(t.muxCode) ? x$4("The {tokenNamePrefix}-token is formatted with incorrect information.", a).format({ tokenNamePrefix: n }) : [C$3.NETWORK_TOKEN_MISSING, C$3.NETWORK_INVALID_URL].includes(t.muxCode) ? x$4("The video URL or {tokenNamePrefix}-token are formatted with incorrect or incomplete information.", a).format({ tokenNamePrefix: n }) : t.muxCode === C$3.NETWORK_NOT_FOUND ? "" : t.message;
	}
	return t.code && (t.code === m.MEDIA_ERR_NETWORK || t.code === m.MEDIA_ERR_DECODE || (t.code, m.MEDIA_ERR_SRC_NOT_SUPPORTED)), t.message;
}, At = (t, a = !1) => {
	return {
		title: ca(t, a).toString(),
		message: pa(t, a).toString()
	};
}, ba = (t) => {
	if (t.muxCode) {
...
`;
var xe$1 = w.createElement("template");
"innerHTML" in xe$1 && (xe$1.innerHTML = Ct);
var kt, _t, me$1 = class extends MediaThemeElement {};
me$1.template = (_t = (kt = xe$1.content) == null ? void 0 : kt.children) == null ? void 0 : _t[0];
...
function Aa(t, a) {
	...
	return {
		...
		streamType: z(t.getAttribute(t$1.STREAM_TYPE)),
	...
	if (t instanceof m) {
      ...
      ${i != null && i.message || i != null && i.linkUrl ? `<p>
        ...
        ${i != null && i.linkUrl ? `<a
              ...
              aria-label="${(a = i.linkText) != null ? a : ""} ${x$4("(opens in a new window)")}"
...
var Ra = Object.values(t$1), xa = Object.values(M$1), Oa = Object.values(o$1), Mt = se$1(), St = "mux-player", Nt = { isDialogOpen: !1 }, La = { redundant_streams: !0 }, J, ee$1, te$1, P$1, ae$1, K, m$3, I, Pt, Ie, H, wt, Dt, Ut, Vt, Ne = class extends Ce {
	constructor() {
		super();
		v(this, m$3);
		v(this, J);
		...
		v(this, te$1, {});
		v(this, P$1, !0);
		v(this, ae$1, new ne$1(this, "hotkeys"));
		v(this, K, {
			...Nt,
			onCloseErrorDialog: (e) => {
				var r;
				((r = e.composedPath()[0]) == null ? void 0 : r.localName) === "media-error-dialog" && p$2(this, m$3, Ie).call(this, { isDialogOpen: !1 });
			},
		...
		C(this, J, Tn()), this.attachShadow({ mode: "open" }), p$2(this, m$3, Pt).call(this), this.isConnected && p$2(this, m$3, I).call(this);
	}
	static get NAME() {
		return St;
	}
	...
	attributeChangedCallback(e, i, r) {
		switch (p$2(this, m$3, I).call(this), super.attributeChangedCallback(e, i, r), e) {
			case o$1.HOTKEYS:
				u$1(this, ae$1).value = r;
				break;
			case o$1.THUMBNAIL_TIME:
				r != null && this.tokens.thumbnail && x$1(x$4("Use of thumbnail-time with thumbnail-token is currently unsupported. Ignore thumbnail-time.").toString());
				break;
			case o$1.THUMBNAIL_TOKEN:
				if (r) {
					let d = re$2(r);
					if (d) {
						let { aud: l } = d, b = ce$1.THUMBNAIL;
						l !== b && x$1(x$4("The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.").format({
							aud: l,
							expectedAud: b,
			...
			case o$1.DRM_TOKEN:
				...
				break;
			case t$1.PLAYBACK_ID:
				r != null && r.includes("?token") && E$2(x$4("The specificed playback ID {playbackId} contains a token which must be provided via the playback-token attribute.").format({ playbackId: r }));
				break;
			case t$1.STREAM_TYPE:
				r && ![
					L$1.LIVE,
					...
					message: x$4("Invalid stream-type value supplied: `{streamType}`. Please provide stream-type as either: `on-demand` or `live`").format({ streamType: this.streamType })
				}) : r === L$1.LIVE ? this.getAttribute(o$1.TARGET_LIVE_WINDOW) ?? (this.targetLiveWindow = 0) : this.targetLiveWindow = NaN;
				break;
		...
		[
			...
			...u$1(this, K),
			...Nt
		}), p$2(this, m$3, H).call(this, { [lt(e)]: r });
	}
	async requestFullscreen(e) {
		var i;
		if (!(!this.mediaController || this.mediaController.hasAttribute(MediaUIAttributes.MEDIA_IS_FULLSCREEN))) return (i = this.mediaController) == null || i.dispatchEvent(new k.CustomEvent(MediaUIEvents.MEDIA_ENTER_FULLSCREEN_REQUEST, {
			composed: !0,
			bubbles: !0
		})), new Promise((r, n) => {
			var d;
	...
	async exitFullscreen() {
		var e;
		if (!(!this.mediaController || !this.mediaController.hasAttribute(MediaUIAttributes.MEDIA_IS_FULLSCREEN))) return (e = this.mediaController) == null || e.dispatchEvent(new k.CustomEvent(MediaUIEvents.MEDIA_EXIT_FULLSCREEN_REQUEST, {
			composed: !0,
			bubbles: !0
		})), new Promise((i, r) => {
			var n;
	...
	set preferCmcd(e) {
		e !== this.preferCmcd && (e ? ir.includes(e) ? this.setAttribute(t$1.PREFER_CMCD, e) : x$1(`Invalid value for preferCmcd. Must be one of ${ir.join()}`) : this.removeAttribute(t$1.PREFER_CMCD));
	}
	get hasPlayed() {
		var e, i;
	...
	get theme() {
		var e;
		return (e = this.getAttribute(o$1.THEME)) != null ? e : va;
	}
	set theme(e) {
	...
	set themeProps(e) {
		...
		for (let d in i) {
			...
			typeof l == "boolean" || l == null ? (r = this.mediaTheme) == null || r.toggleAttribute(re$1(d), !!l) : (n = this.mediaTheme) == null || n.setAttribute(re$1(d), l);
		}
	}
	get playbackId() {
		var e;
	...
	get src() {
		var e, i;
		return this.playbackId ? (e = V(this, M$1.SRC)) != null ? e : void 0 : (i = this.getAttribute(M$1.SRC)) != null ? i : void 0;
	}
	set src(e) {
		e ? this.setAttribute(M$1.SRC, e) : this.removeAttribute(M$1.SRC);
	}
	get poster() {
		var r;
		let e = this.getAttribute(M$1.POSTER);
		if (e != null) return e;
		let { tokens: i } = this;
	...
	set poster(e) {
		e || e === "" ? this.setAttribute(M$1.POSTER, e) : this.removeAttribute(M$1.POSTER);
	}
	get storyboardSrc() {
		var e;
	...
	get storyboard() {
		...
		if (!(this.audio || !this.playbackId || !this.streamType || [L$1.LIVE, L$1.UNKNOWN].includes(this.streamType) || e.playback && !e.storyboard)) return dt(this.playbackId, {
			customDomain: this.customDomain,
			token: e.storyboard,
	...
	get forwardSeekOffset() {
		var e;
		return (e = y$1(this.getAttribute(o$1.FORWARD_SEEK_OFFSET))) != null ? e : 10;
	}
	...
	get backwardSeekOffset() {
		var e;
		return (e = y$1(this.getAttribute(o$1.BACKWARD_SEEK_OFFSET))) != null ? e : 10;
	}
	...
	get playerInitTime() {
		return this.hasAttribute(t$1.PLAYER_INIT_TIME) ? y$1(this.getAttribute(t$1.PLAYER_INIT_TIME)) : u$1(this, J);
	}
	set playerInitTime(e) {
		e != this.playerInitTime && (e == null ? this.removeAttribute(t$1.PLAYER_INIT_TIME) : this.setAttribute(t$1.PLAYER_INIT_TIME, `${+e}`));
	}
	get playerSoftwareName() {
		var e;
		return (e = this.getAttribute(t$1.PLAYER_SOFTWARE_NAME)) != null ? e : St;
	}
	get playerSoftwareVersion() {
		var e;
		return (e = this.getAttribute(t$1.PLAYER_SOFTWARE_VERSION)) != null ? e : Mt;
	}
	get beaconCollectionDomain() {
		var e;
		return (e = this.getAttribute(t$1.BEACON_COLLECTION_DOMAIN)) != null ? e : void 0;
	...
	get programStartTime() {
		return y$1(this.getAttribute(t$1.PROGRAM_START_TIME));
	}
	set programStartTime(e) {
		e == null ? this.removeAttribute(t$1.PROGRAM_START_TIME) : this.setAttribute(t$1.PROGRAM_START_TIME, `${e}`);
	}
	get programEndTime() {
		return y$1(this.getAttribute(t$1.PROGRAM_END_TIME));
	}
	set programEndTime(e) {
		e == null ? this.removeAttribute(t$1.PROGRAM_END_TIME) : this.setAttribute(t$1.PROGRAM_END_TIME, `${e}`);
	}
	get assetStartTime() {
		return y$1(this.getAttribute(t$1.ASSET_START_TIME));
	}
	set assetStartTime(e) {
		e == null ? this.removeAttribute(t$1.ASSET_START_TIME) : this.setAttribute(t$1.ASSET_START_TIME, `${e}`);
	}
	get assetEndTime() {
		return y$1(this.getAttribute(t$1.ASSET_END_TIME));
	}
	set assetEndTime(e) {
		e == null ? this.removeAttribute(t$1.ASSET_END_TIME) : this.setAttribute(t$1.ASSET_END_TIME, `${e}`);
	}
	get extraSourceParams() {
		return this.hasAttribute(o$1.EXTRA_SOURCE_PARAMS) ? [...new URLSearchParams(this.getAttribute(o$1.EXTRA_SOURCE_PARAMS)).entries()].reduce((e, [i, r]) => (e[i] = r, e), {}) : La;
	}
	...
	get streamType() {
		var e, i, r;
		return (r = (i = this.getAttribute(t$1.STREAM_TYPE)) != null ? i : (e = this.media) == null ? void 0 : e.streamType) != null ? r : L$1.UNKNOWN;
	}
	set streamType(e) {
	...
	get defaultStreamType() {
		var e, i, r;
		return (r = (i = this.getAttribute(o$1.DEFAULT_STREAM_TYPE)) != null ? i : (e = this.mediaController) == null ? void 0 : e.getAttribute(o$1.DEFAULT_STREAM_TYPE)) != null ? r : L$1.ON_DEMAND;
	}
	...
	get startTime() {
		return y$1(V(this, t$1.START_TIME));
	}
	set startTime(e) {
	...
	set metadata(e) {
		if (p$2(this, m$3, I).call(this), !this.media) {
	...
	set capRenditionToPlayerSize(e) {
		if (!this.media) {
			E$2("underlying media element missing when trying to set capRenditionToPlayerSize");
			return;
		}
		this.media.capRenditionToPlayerSize = e;
	}
};
J = /* @__PURE__ */ new WeakMap(), ee$1 = /* @__PURE__ */ new WeakMap(), te$1 = /* @__PURE__ */ new WeakMap(), P$1 = /* @__PURE__ */ new WeakMap(), ae$1 = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), m$3 = /* @__PURE__ */ new WeakSet(), I = function() {
	var e, i, r, n;
	if (!u$1(this, ee$1)) {
		C(this, ee$1, !0), p$2(this, m$3, H).call(this);
		try {
		...
		p$2(this, m$3, wt).call(this), p$2(this, m$3, Dt).call(this), p$2(this, m$3, Ut).call(this), C(this, P$1, (i = (e = this.mediaController) == null ? void 0 : e.hasAttribute(Attributes$13.USER_INACTIVE)) != null ? i : !0), p$2(this, m$3, Vt).call(this), (r = this.media) == null || r.addEventListener("streamtypechange", () => p$2(this, m$3, H).call(this)), (n = this.media) == null || n.addEventListener("loadstart", () => p$2(this, m$3, H).call(this));
	}
}, Pt = function() {
	var e, i;
	try {
	...
	Object.assign(u$1(this, K), e), p$2(this, m$3, H).call(this);
}, H = function(e = {}) {
	gt(yt(Aa(this, {
		...u$1(this, K),
		...e
	...
	let e = (i) => {
		...
		if (!(r != null && r.fatal)) {
			x$1(r), r.data && x$1(`${r.name} data:`, r.data);
			return;
		}
		let n = Re(r, !1);
		n.message && ve(n), E$2(r), r.data && E$2(`${r.name} data:`, r.data), p$2(this, m$3, Ie).call(this, { isDialogOpen: !0 });
	};
	this.addEventListener("error", e), this.media && (this.media.errorTranslator = (i = {}) => {
		var n, d, l;
		if (!(((n = this.media) == null ? void 0 : n.error) instanceof m)) return i;
	...
	var i, r, n, d;
	let e = () => p$2(this, m$3, H).call(this);
	...
	let i, r = /* @__PURE__ */ new WeakMap(), n = () => this.streamType === L$1.LIVE && !this.secondaryColor && this.offsetWidth >= 800, d = (_, A, R = !1) => {
		if (n()) return;
		Array.from(_ && _.activeCues || []).forEach((h) => {
			if (!(!h.snapToLines || h.line < -5 || h.line >= 0 && h.line < 10)) if (!A || this.paused) {
				let ie = h.text.split(`
`).length, W = -3;
				this.streamType === L$1.LIVE && (W = -2);
				let Z = W - ie;
		...
		var _, A;
		d(i, (A = (_ = this.mediaController) == null ? void 0 : _.hasAttribute(Attributes$13.USER_INACTIVE)) != null ? A : !1);
	}, b = () => {
		var R, $;
		let A = Array.from((($ = (R = this.mediaController) == null ? void 0 : R.media) == null ? void 0 : $.textTracks) || []).filter((h) => ["subtitles", "captions"].includes(h.kind) && h.mode === "showing")[0];
		A !== i && i?.removeEventListener("cuechange", l), i = A, i?.addEventListener("cuechange", l), d(i, u$1(this, P$1));
	};
	b(), (S = this.textTracks) == null || S.addEventListener("change", b), (Y = this.textTracks) == null || Y.addEventListener("addtrack", b), this.addEventListener("userinactivechange", () => {
		var A, R;
		let _ = (R = (A = this.mediaController) == null ? void 0 : A.hasAttribute(Attributes$13.USER_INACTIVE)) != null ? R : !0;
		u$1(this, P$1) !== _ && (C(this, P$1, _), d(i, u$1(this, P$1)));
	});
};
function V(t, a) {
	return t.media ? t.media.getAttribute(a) : t.getAttribute(a);
...
l.customElements.get("mux-player") || (l.customElements.define("mux-player", _i), l.MuxPlayerElement = _i);
//#endregion
...
//# sourceMappingURL=dist-D844NJlA.js.map