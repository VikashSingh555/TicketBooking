...
const require_versionSelector = require('./versionSelector-1fCPj_JX.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.6.1")}/dist/ui.browser.js`;
};
